...
Axiom sawUnsafeAssert : forall (a : Type), forall (x : a), forall (y : a), (@Eq (a) (x) (y)) .
...
Axiom drop0 : forall (a : Type), forall (n : (@Nat)), forall (v : (@SAWCoreVectorsAsCoqVectors.Vec ((@SAWCorePrelude.addNat (0) (n))) (a))), (@Eq ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) ((@SAWCorePrelude.drop (a) (0) (n) (v))) (v)) .
...
Axiom rotateL : forall (n : (@Nat)), forall (a : Type), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@Nat)) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) .

Axiom rotateR : forall (n : (@Nat)), forall (a : Type), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@Nat)) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) .

Axiom shiftL : forall (n : (@Nat)), forall (a : Type), (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@Nat)) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) .

Axiom shiftR : forall (n : (@Nat)), forall (a : Type), (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@Nat)) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) .
...
Definition bvAt : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> a :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.sawAt (n) (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).
...
Definition bvUpd : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (a) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) (y : a) => (@SAWCorePrelude.upd (n) (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))) (y))).
...
Definition bvRotateL : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.rotateL (n) (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).
...
Definition bvRotateR : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.rotateR (n) (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).
...
Definition bvShiftL : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (z : a) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.shiftL (n) (a) (z) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).
...
Definition bvShiftR : forall (n : (@Nat)), forall (a : Type), forall (w : (@Nat)), (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@SAWCoreVectorsAsCoqVectors.Vec (n) (a)) :=
  (fun (n : (@Nat)) (a : Type) (w : (@Nat)) (z : a) (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.shiftR (n) (a) (z) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).

Axiom bvAdd : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvugt : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvuge : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvult : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvule : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvsgt : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvsge : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvslt : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvsle : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool .

Axiom bvPopcount : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvCountLeadingZeros : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvCountTrailingZeros : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Definition bvCarry : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> @SAWCoreScaffolding.Bool :=
  (fun (n : (@Nat)) (x : (@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))) (y : (@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.bvult (n) ((@SAWCorePrelude.bvAdd (n) (x) (y))) (x))).

Definition bvSCarry : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector ((@Succ (n))))) -> ((@SAWCorePrelude.bitvector ((@Succ (n))))) -> @SAWCoreScaffolding.Bool :=
  (fun (n : (@Nat)) (x : (@SAWCoreVectorsAsCoqVectors.Vec ((@Succ (n))) (@SAWCoreScaffolding.Bool))) (y : (@SAWCoreVectorsAsCoqVectors.Vec ((@Succ (n))) (@SAWCoreScaffolding.Bool))) => (@SAWCoreScaffolding.and ((@SAWCoreScaffolding.boolEq ((@SAWCorePrelude.msb (n) (x))) ((@SAWCorePrelude.msb (n) (y))))) ((@SAWCoreScaffolding.xor ((@SAWCorePrelude.msb (n) (x))) ((@SAWCorePrelude.msb (n) ((@SAWCorePrelude.bvAdd ((@Succ (n))) (x) (y))))))))).
...
Axiom bvSub : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvMul : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvLg2 : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvUDiv : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvURem : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> ((@SAWCorePrelude.bitvector (n))) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvSDiv : forall (x : (@Nat)), ((@SAWCorePrelude.bitvector ((@Succ (x))))) -> ((@SAWCorePrelude.bitvector ((@Succ (x))))) -> (@SAWCorePrelude.bitvector ((@Succ (x)))) .

Axiom bvSRem : forall (x : (@Nat)), ((@SAWCorePrelude.bitvector ((@Succ (x))))) -> ((@SAWCorePrelude.bitvector ((@Succ (x))))) -> (@SAWCorePrelude.bitvector ((@Succ (x)))) .

Axiom bvShl : forall (w : (@Nat)), ((@SAWCorePrelude.bitvector (w))) -> ((@Nat)) -> (@SAWCorePrelude.bitvector (w)) .

Axiom bvShr : forall (w : (@Nat)), ((@SAWCorePrelude.bitvector (w))) -> ((@Nat)) -> (@SAWCorePrelude.bitvector (w)) .

Axiom bvSShr : forall (w : (@Nat)), ((@SAWCorePrelude.bitvector ((@Succ (w))))) -> ((@Nat)) -> (@SAWCorePrelude.bitvector ((@Succ (w)))) .

Axiom bvShiftL_bvShl : forall (n : (@Nat)), forall (w : (@Nat)), forall (x : (@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))), forall (i : (@SAWCorePrelude.bitvector (w))), (@Eq ((@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))) ((@SAWCorePrelude.bvShiftL (n) (@SAWCoreScaffolding.Bool) (w) (@SAWCoreScaffolding.False) (x) (i))) ((@SAWCorePrelude.bvShl (n) (x) ((@SAWCorePrelude.bvToNat (w) (i)))))) .

Axiom bvShiftR_bvShr : forall (n : (@Nat)), forall (w : (@Nat)), forall (x : (@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))), forall (i : (@SAWCorePrelude.bitvector (w))), (@Eq ((@SAWCoreVectorsAsCoqVectors.Vec (n) (@SAWCoreScaffolding.Bool))) ((@SAWCorePrelude.bvShiftR (n) (@SAWCoreScaffolding.Bool) (w) (@SAWCoreScaffolding.False) (x) (i))) ((@SAWCorePrelude.bvShr (n) (x) ((@SAWCorePrelude.bvToNat (w) (i)))))) .
...
Axiom bvEq_refl : forall (n : (@Nat)), forall (x : (@SAWCorePrelude.bitvector (n))), (@Eq (@SAWCoreScaffolding.Bool) ((@SAWCorePrelude.bvEq (n) (x) (x))) (@SAWCoreScaffolding.True)) .
...
Definition bvStreamUpd : forall (a : Type), forall (w : (@Nat)), ((@Stream (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (a) -> (@Stream (a)) :=
  (fun (a : Type) (w : (@Nat)) (xs : (@Stream (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) (y : a) => (@SAWCorePrelude.streamUpd (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))) (y))).
...
Definition bvStreamGet : forall (a : Type), forall (w : (@Nat)), ((@Stream (a))) -> ((@SAWCorePrelude.bitvector (w))) -> a :=
  (fun (a : Type) (w : (@Nat)) (xs : (@Stream (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.streamGet (a) (xs) ((@SAWCorePrelude.bvToNat (w) (i))))).

Definition bvStreamShiftL : forall (a : Type), forall (w : (@Nat)), ((@Stream (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@Stream (a)) :=
  (fun (a : Type) (w : (@Nat)) (xs : (@Stream (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.streamDrop (a) ((@SAWCorePrelude.bvToNat (w) (i))) (xs))).

Definition bvStreamShiftR : forall (a : Type), forall (w : (@Nat)), (a) -> ((@Stream (a))) -> ((@SAWCorePrelude.bitvector (w))) -> (@Stream (a)) :=
  (fun (a : Type) (w : (@Nat)) (x : a) (xs : (@Stream (a))) (i : (@SAWCoreVectorsAsCoqVectors.Vec (w) (@SAWCoreScaffolding.Bool))) => (@SAWCorePrelude.streamAppend (a) ((@SAWCorePrelude.bvToNat (w) (i))) ((@SAWCorePrelude.replicate ((@SAWCorePrelude.bvToNat (w) (i))) (a) (x))) (xs))).

Axiom Integer : Type .

Axiom intAdd : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intSub : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intMul : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intDiv : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intMod : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intMin : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intMax : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intNeg : (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intAbs : (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Integer .

Axiom intEq : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCoreScaffolding.Bool .

Axiom intLe : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCoreScaffolding.Bool .

Axiom intLt : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCoreScaffolding.Bool .

Axiom intToNat : (@SAWCorePrelude.Integer) -> (@Nat) .

Axiom natToInt : ((@Nat)) -> @SAWCorePrelude.Integer .

Axiom intToBv : forall (n : (@Nat)), (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.bitvector (n)) .

Axiom bvToInt : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> @SAWCorePrelude.Integer .

Axiom sbvToInt : forall (n : (@Nat)), ((@SAWCorePrelude.bitvector (n))) -> @SAWCorePrelude.Integer .

Axiom IntMod : ((@Nat)) -> Type .

Axiom toIntMod : forall (n : (@Nat)), (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.IntMod (n)) .

Axiom fromIntMod : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> @SAWCorePrelude.Integer .

Axiom intModEq : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> ((@SAWCorePrelude.IntMod (n))) -> @SAWCoreScaffolding.Bool .

Axiom intModAdd : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> ((@SAWCorePrelude.IntMod (n))) -> (@SAWCorePrelude.IntMod (n)) .

Axiom intModSub : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> ((@SAWCorePrelude.IntMod (n))) -> (@SAWCorePrelude.IntMod (n)) .

Axiom intModMul : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> ((@SAWCorePrelude.IntMod (n))) -> (@SAWCorePrelude.IntMod (n)) .

Axiom intModNeg : forall (n : (@Nat)), ((@SAWCorePrelude.IntMod (n))) -> (@SAWCorePrelude.IntMod (n)) .
...
Axiom mkFloat : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Float .

Axiom Double : Type .

Axiom mkDouble : (@SAWCorePrelude.Integer) -> (@SAWCorePrelude.Integer) -> @SAWCorePrelude.Float .

Axiom CompM : (Type) -> Type .

Axiom returnM : forall (a : Type), (a) -> (@SAWCorePrelude.CompM (a)) .

Axiom bindM : forall (a : Type), forall (b : Type), ((@SAWCorePrelude.CompM (a))) -> ((a) -> (@SAWCorePrelude.CompM (b))) -> (@SAWCorePrelude.CompM (b)) .

Definition composeM : forall (a : Type), forall (b : Type), forall (c : Type), ((a) -> (@SAWCorePrelude.CompM (b))) -> ((b) -> (@SAWCorePrelude.CompM (c))) -> (a) -> (@SAWCorePrelude.CompM (c)) :=
  (fun (a : Type) (b : Type) (c : Type) (f : (a) -> (@SAWCorePrelude.CompM (b))) (g : (b) -> (@SAWCorePrelude.CompM (c))) (x : a) => (@SAWCorePrelude.bindM (b) (c) ((f (x))) (g))).

Axiom errorM : forall (a : Type), (@SAWCorePrelude.CompM (a)) .

Axiom catchM : forall (a : Type), ((@SAWCorePrelude.CompM (a))) -> ((@SAWCorePrelude.CompM (a))) -> (@SAWCorePrelude.CompM (a)) .
...
Definition letRecFuns : ((@InputOutputTypes)) -> Type :=
  (fun (tps : (@InputOutputTypes)) => (@InputOutputTypes_rect ((fun (tps : (@InputOutputTypes)) => Type)) (unit) ((fun (a : Type) (b : Type) (_ : (@InputOutputTypes)) (fun_tp : Type) => (prod ((a) -> (@SAWCorePrelude.CompM (b))) (fun_tp)))) (tps))).

Axiom letRecM : forall (tps : (@InputOutputTypes)), forall (b : Type), (((@SAWCorePrelude.letRecFuns (tps))) -> (@SAWCorePrelude.letRecFuns (tps))) -> (((@SAWCorePrelude.letRecFuns (tps))) -> (@SAWCorePrelude.CompM (b))) -> (@SAWCorePrelude.CompM (b)) .

Definition letRecM1 : forall (a : Type), forall (b : Type), forall (c : Type), (((a) -> (@SAWCorePrelude.CompM (b))) -> (a) -> (@SAWCorePrelude.CompM (b))) -> (((a) -> (@SAWCorePrelude.CompM (b))) -> (@SAWCorePrelude.CompM (c))) -> (@SAWCorePrelude.CompM (c)) :=
  (fun (a : Type) (b : Type) (c : Type) (fn : ((a) -> (@SAWCorePrelude.CompM (b))) -> (a) -> (@SAWCorePrelude.CompM (b))) (body : ((a) -> (@SAWCorePrelude.CompM (b))) -> (@SAWCorePrelude.CompM (c))) => (@SAWCorePrelude.letRecM ((@TypesCons (a) (b) ((@TypesNil)))) (c) ((fun (funs : (prod ((a) -> (@SAWCorePrelude.CompM (b))) (unit))) => (pair ((fn ((fst (funs))))) (tt)))) ((fun (funs : (prod ((a) -> (@SAWCorePrelude.CompM (b))) (unit))) => (body ((fst (funs)))))))).

Definition fixM : forall (a : Type), forall (b : Type), (((a) -> (@SAWCorePrelude.CompM (b))) -> (a) -> (@SAWCorePrelude.CompM (b))) -> (a) -> (@SAWCorePrelude.CompM (b)) :=
...
Axiom ite_join_cong : forall (b : @SAWCoreScaffolding.Bool), forall (x : (@SAWCoreVectorsAsCoqVectors.Vec (12) ((@SAWCoreVectorsAsCoqVectors.Vec (32) (@SAWCoreScaffolding.Bool))))), forall (y : (@SAWCoreVectorsAsCoqVectors.Vec (12) ((@SAWCoreVectorsAsCoqVectors.Vec (32) (@SAWCoreScaffolding.Bool))))), (@Eq ((@SAWCoreVectorsAsCoqVectors.Vec (384) (@SAWCoreScaffolding.Bool))) ((@SAWCorePrelude.join (12) (32) (@SAWCoreScaffolding.Bool) (if b then x else y))) (if b then (@SAWCorePrelude.join (12) (32) (@SAWCoreScaffolding.Bool) (x)) else (@SAWCorePrelude.join (12) (32) (@SAWCoreScaffolding.Bool) (y)))) .

Axiom map_map : forall (a : Type), forall (b : Type), forall (c : Type), forall (f : (a) -> b), forall (g : (b) -> c), forall (n : (@Nat)), forall (xs : (@SAWCoreVectorsAsCoqVectors.Vec (n) (a))), (@Eq ((@SAWCoreVectorsAsCoqVectors.Vec (n) (c))) ((@SAWCorePrelude.map (b) (c) (g) (n) ((@SAWCorePrelude.map (a) (b) (f) (n) (xs))))) ((@SAWCorePrelude.map (a) (c) ((fun (x : a) => (g ((f (x)))))) (n) (xs)))) .
