...
Scheme Induction for Coq.Classes.RelationClasses.Equivalence Sort Set.
Scheme Induction for Coq.Classes.RelationClasses.Equivalence Sort Type.

Scheme Minimality for Coq.Classes.RelationClasses.PER Sort Prop.
Scheme Induction for Coq.Classes.RelationClasses.PER Sort Set.
Scheme Induction for Coq.Classes.RelationClasses.PER Sort Type.
...
(* Preprocess Module Coq.ZArith.BinInt *)
(*   as BinInt' *)
(*        { opaque *)
...
Scheme Minimality for tuple_of Sort Prop.
...
End SAWCoreScaffolding.

From Coq Require Import Numbers.BinNums.

Preprocess Module Coq.Numbers.BinNums as BinNums'.

(* Preprocess Module Coq.Numbers.Cyclic.ZModulo.ZModulo *)
(*   as ZModulo' *)
(*        { opaque *)
(*            Coq.ZArith.BinInt.Z.testbit *)
(*            Coq.ZArith.BinInt.Z.testbit_of_N *)
(*            Coq.ZArith.BinInt.Z.bits_above_log2_neg *)
(*            Coq.ZArith.BinInt.Z.log2_spec_alt *)
(*            Coq.ZArith.BinInt.Z.bits_above_log2 *)
(*            Coq.ZArith.BinInt.Z.log2_nonneg *)
(*            Coq.ZArith.BinInt.Z.log2_pow2 *)
(*            Coq.ZArith.BinInt.Z.log2_lt_cancel *)
(*        }. *)

(* Module M. *)
(*   Definition fromIntMod : positive -> Z -> Z := ZModulo.to_Z. *)
(* End M. *)
