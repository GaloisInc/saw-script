...
Definition bvuleWithProof : forall (n : ((@SAWCoreScaffolding.Nat))), forall (v1 : ((@bitvector) (n))), forall (v2 : ((@bitvector) (n))), ((@Maybe) (((@SAWCoreScaffolding.EqP) (((@SAWCoreScaffolding.Bool))) (((@bvule) (n) (v1) (v2))) (((@SAWCoreScaffolding.true)))))) :=
...
Definition sliceBVVec : forall (n : ((@SAWCoreScaffolding.Nat))), forall (len : ((@bitvector) (n))), forall (a : Type), forall (start' : ((@bitvector) (n))), forall (len' : ((@bitvector) (n))), (((@is_bvule) (n) (start') (len))) -> (((@is_bvule) (n) (len') (((@SAWCoreVectorsAsCoqVectors.bvSub) (n) (len) (start'))))) -> (((@BVVec) (n) (len) (a))) -> ((@BVVec) (n) (len') (a)) :=
  (fun (n : ((@SAWCoreScaffolding.Nat))) (len : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCoreScaffolding.Bool))))) (a : Type) (start' : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCoreScaffolding.Bool))))) (len' : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCoreScaffolding.Bool))))) (pf1 : ((@SAWCoreScaffolding.EqP) (((@SAWCoreScaffolding.Bool))) (((@bvule) (n) (start') (len))) (((@SAWCoreScaffolding.true))))) (pf2 : ((@SAWCoreScaffolding.EqP) (((@SAWCoreScaffolding.Bool))) (((@bvule) (n) (len') (((@SAWCoreVectorsAsCoqVectors.bvSub) (n) (len) (start'))))) (((@SAWCoreScaffolding.true))))) (v : ((@BVVec) (n) (len) (a))) => ((@takeBVVec) (n) (((@SAWCoreVectorsAsCoqVectors.bvSub) (n) (len) (start'))) (a) (len') (pf2) (((@dropBVVec) (n) (len) (a) (start') (pf1) (v))))).
