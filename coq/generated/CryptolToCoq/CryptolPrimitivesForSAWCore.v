...
Definition ecTrace : forall (n : ((@Num))), forall (a : Type), forall (b : Type), (((@seq) (n) (((@SAWCorePrelude.bitvector) (8))))) -> (a) -> (b) -> b :=
  (fun (_1 : ((@Num))) (_2 : Type) (_3 : Type) (_4 : ((CryptolPrimitives.Num_rect) ((fun (num : ((@Num))) => Type)) ((fun (n : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCorePrelude.bitvector) (8)))))) (((@SAWCorePrelude.Stream) (((@SAWCorePrelude.bitvector) (8))))) (_1))) (_5 : _2) (x : _3) => x).
...
Definition ecSExt : forall (m : ((@Num))), forall (n : ((@Num))), (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (((@tcAdd) (m) (n))) (((@SAWCoreScaffolding.Bool)))) :=
  ((@finNumRec2) ((fun (m : ((@Num))) (n : ((@Num))) => (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (((@tcAdd) (m) (n))) (((@SAWCoreScaffolding.Bool)))))) ((fun (m : ((@SAWCoreScaffolding.Nat))) (n : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.natCase) ((fun (n' : ((@SAWCoreScaffolding.Nat))) => (((@SAWCorePrelude.bitvector) (n'))) -> ((@SAWCorePrelude.bitvector) (((@SAWCorePrelude.addNat) (m) (n')))))) ((fun (_1 : ((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) => ((@SAWCoreVectorsAsCoqVectors.bvNat) (((@SAWCorePrelude.addNat) (m) (0))) (0)))) (((@SAWCorePrelude.bvSExt) (m))) (n))))).
