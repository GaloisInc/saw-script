...
Definition compose : forall (a : Type), forall (b : Type), forall (c : Type), ((b) -> c) -> ((a) -> b) -> (a) -> c :=
  (fun (_ : Type) (__0 : Type) (__1 : Type) (f : (__0) -> __1) (g : (_) -> __0) (x : _) => ((f) (((g) (x))))).
...
Definition getFinNat : forall (n : ((@Num))), ((@SAWCoreScaffolding.Nat)) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@SAWCoreScaffolding.Nat)))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => n_0)) (((@SAWCoreScaffolding.error) (((@SAWCoreScaffolding.Nat))) (("Unexpected Fin constraint violation!")%string))) (n))).
...
Definition tcWidth : (((@Num))) -> ((@Num)) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@Num)))) ((fun (x : ((@SAWCoreScaffolding.Nat))) => ((@TCNum) (((@SAWCoreScaffolding.widthNat) (x)))))) (((@TCInf))) (n))).
...
Definition seq : (((@Num))) -> (Type) -> Type :=
  (fun (num : ((@Num))) (a : Type) => ((CryptolPrimitives.Num_rect) ((fun (num_0 : ((@Num))) => Type)) ((fun (n : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a)))) (((@SAWCorePrelude.Stream) (a))) (num))).
...
Definition seqConst : forall (n : ((@Num))), forall (a : Type), (a) -> ((@seq) (n) (a)) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (a) -> ((@seq) (n_0) (a)))) (((@SAWCorePrelude.replicate))) (((@SAWCorePrelude.streamConst))) (n))).
...
Definition ecParmap : forall (a : Type), forall (b : Type), forall (n : ((@Num))), ((a) -> b) -> (((@seq) (n) (a))) -> ((@seq) (n) (b)) :=
  (fun (a : Type) (b : Type) (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((a) -> b) -> (((@seq) (n_0) (a))) -> ((@seq) (n_0) (b)))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (f : (a) -> b) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))) => ((@SAWCorePrelude.map) (a) (b) (f) (n_0) (xs)))) ((fun (f : (a) -> b) (xs : ((@SAWCorePrelude.Stream) (a))) => ((@SAWCoreScaffolding.error) (((@SAWCorePrelude.Stream) (b))) (("Unexpected infinite stream in parmap")%string)))) (n))).
...
Definition eListSel : forall (a : Type), forall (n : ((@Num))), (((@seq) (n) (a))) -> (((@SAWCoreScaffolding.Nat))) -> a :=
  (fun (a : Type) (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (num : ((@Num))) => (((@seq) (num) (a))) -> (((@SAWCoreScaffolding.Nat))) -> a)) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.sawAt) (n_0) (a)))) (((@SAWCorePrelude.streamGet) (a))) (n))).

Definition from : forall (a : Type), forall (b : Type), forall (m : ((@Num))), forall (n : ((@Num))), (((@seq) (m) (a))) -> ((a) -> ((@seq) (n) (b))) -> ((@seq) (((@tcMul) (m) (n))) (((prod) (a) (b)))) :=
  (fun (a : Type) (b : Type) (m : ((@Num))) (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (m_0 : ((@Num))) => (((@seq) (m_0) (a))) -> ((a) -> ((@seq) (n) (b))) -> ((@seq) (((@tcMul) (m_0) (n))) (((prod) (a) (b)))))) ((fun (m_0 : ((@SAWCoreScaffolding.Nat))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a))) -> ((a) -> ((@seq) (n_0) (b))) -> ((@seq) (((@tcMul) (((@TCNum) (m_0))) (n_0))) (((prod) (a) (b)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a))) (k : (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (b))) => ((@SAWCorePrelude.join) (m_0) (n_0) (((prod) (a) (b))) (((@SAWCorePrelude.map) (a) (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((prod) (a) (b))))) ((fun (x : a) => ((@SAWCorePrelude.map) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (n_0) (((k) (x)))))) (m_0) (xs)))))) (((@SAWCorePrelude.natCase) ((fun (m' : ((@SAWCoreScaffolding.Nat))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (m') (a))) -> ((a) -> ((@SAWCorePrelude.Stream) (b))) -> ((@seq) (((@SAWCorePrelude.if0Nat) (((@Num))) (m') (((@TCNum) (0))) (((@TCInf))))) (((prod) (a) (b)))))) ((fun (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (0) (a))) (k : (a) -> ((@SAWCorePrelude.Stream) (b))) => ((@SAWCoreVectorsAsCoqVectors.EmptyVec) (((prod) (a) (b)))))) ((fun (m' : ((@SAWCoreScaffolding.Nat))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (((@SAWCoreScaffolding.Succ) (m'))) (a))) (k : (a) -> ((@SAWCorePrelude.Stream) (b))) => (((fun (x : a) => ((@SAWCorePrelude.streamMap) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (((k) (x)))))) (((@SAWCorePrelude.sawAt) (((@SAWCoreScaffolding.Succ) (m'))) (a) (xs) (0)))))) (m_0))) (n)))) (((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCorePrelude.Stream) (a))) -> ((a) -> ((@seq) (n_0) (b))) -> ((@seq) (((@tcMul) (((@TCInf))) (n_0))) (((prod) (a) (b)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.natCase) ((fun (n' : ((@SAWCoreScaffolding.Nat))) => (((@SAWCorePrelude.Stream) (a))) -> ((a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n') (b))) -> ((@seq) (((@SAWCorePrelude.if0Nat) (((@Num))) (n') (((@TCNum) (0))) (((@TCInf))))) (((prod) (a) (b)))))) ((fun (xs : ((@SAWCorePrelude.Stream) (a))) (k : (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (0) (b))) => ((@SAWCoreVectorsAsCoqVectors.EmptyVec) (((prod) (a) (b)))))) ((fun (n' : ((@SAWCoreScaffolding.Nat))) (xs : ((@SAWCorePrelude.Stream) (a))) (k : (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (((@SAWCoreScaffolding.Succ) (n'))) (b))) => ((@SAWCorePrelude.streamJoin) (((prod) (a) (b))) (n') (((@SAWCorePrelude.streamMap) (a) (((@SAWCoreVectorsAsCoqVectors.Vec) (((@SAWCoreScaffolding.Succ) (n'))) (((prod) (a) (b))))) ((fun (x : a) => ((@SAWCorePrelude.map) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (((@SAWCoreScaffolding.Succ) (n'))) (((k) (x)))))) (xs)))))) (n_0)))) ((fun (xs : ((@SAWCorePrelude.Stream) (a))) (k : (a) -> ((@SAWCorePrelude.Stream) (b))) => (((fun (x : a) => ((@SAWCorePrelude.streamMap) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (((k) (x)))))) (((@SAWCorePrelude.streamGet) (a) (xs) (0)))))) (n))) (m))).

Definition mlet : forall (a : Type), forall (b : Type), forall (n : ((@Num))), (a) -> ((a) -> ((@seq) (n) (b))) -> ((@seq) (n) (((prod) (a) (b)))) :=
  (fun (a : Type) (b : Type) (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (a) -> ((a) -> ((@seq) (n_0) (b))) -> ((@seq) (n_0) (((prod) (a) (b)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (x : a) (f : (a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (b))) => ((@SAWCorePrelude.map) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (n_0) (((f) (x)))))) ((fun (x : a) (f : (a) -> ((@SAWCorePrelude.Stream) (b))) => ((@SAWCorePrelude.streamMap) (b) (((prod) (a) (b))) ((fun (y : b) => ((pair) (x) (y)))) (((f) (x)))))) (n))).

Definition seqZip : forall (a : Type), forall (b : Type), forall (m : ((@Num))), forall (n : ((@Num))), (((@seq) (m) (a))) -> (((@seq) (n) (b))) -> ((@seq) (((@tcMin) (m) (n))) (((prod) (a) (b)))) :=
  (fun (a : Type) (b : Type) (m : ((@Num))) (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (m_0 : ((@Num))) => (((@seq) (m_0) (a))) -> (((@seq) (n) (b))) -> ((@seq) (((@tcMin) (m_0) (n))) (((prod) (a) (b)))))) ((fun (m_0 : ((@SAWCoreScaffolding.Nat))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a))) -> (((@seq) (n_0) (b))) -> ((@seq) (((@tcMin) (((@TCNum) (m_0))) (n_0))) (((prod) (a) (b)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.zip) (a) (b) (m_0) (n_0)))) ((fun (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a))) (ys : ((@SAWCorePrelude.Stream) (b))) => ((@SAWCoreVectorsAsCoqVectors.gen) (m_0) (((prod) (a) (b))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((pair) (((@SAWCorePrelude.sawAt) (m_0) (a) (xs) (i))) (((@SAWCorePrelude.streamGet) (b) (ys) (i))))))))) (n)))) (((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCorePrelude.Stream) (a))) -> (((@seq) (n_0) (b))) -> ((@seq) (((@tcMin) (((@TCInf))) (n_0))) (((prod) (a) (b)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (xs : ((@SAWCorePrelude.Stream) (a))) (ys : ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (b))) => ((@SAWCoreVectorsAsCoqVectors.gen) (n_0) (((prod) (a) (b))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((pair) (((@SAWCorePrelude.streamGet) (a) (xs) (i))) (((@SAWCorePrelude.sawAt) (n_0) (b) (ys) (i))))))))) (((@SAWCorePrelude.streamMap2) (a) (b) (((prod) (a) (b))) ((fun (x : a) (y : b) => ((pair) (x) (y)))))) (n))) (m))).
...
Definition errorBinary : forall (s : ((@SAWCoreScaffolding.String))), forall (a : Type), (a) -> (a) -> a :=
  (fun (s : ((@SAWCoreScaffolding.String))) (a : Type) (_ : a) (__0 : a) => ((@SAWCoreScaffolding.error) (a) (s))).
...
Definition vecCmp : forall (n : ((@SAWCoreScaffolding.Nat))), forall (a : Type), ((a) -> (a) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool)) :=
  (fun (n : ((@SAWCoreScaffolding.Nat))) (a : Type) (f : (a) -> (a) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) (ys : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) (k : ((@SAWCoreScaffolding.Bool))) => ((@SAWCoreVectorsAsCoqVectors.foldr) ((((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) (((@SAWCoreScaffolding.Bool))) (n) ((fun (f_0 : (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) => f_0)) (k) (((@SAWCorePrelude.zipWith) (a) (a) ((((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) (f) (n) (xs) (ys))))).

Definition unitCmp : (unit) -> (unit) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool)) :=
  (fun (_ : unit) (__0 : unit) (__1 : ((@SAWCoreScaffolding.Bool))) => ((@SAWCoreScaffolding.false))).
...
Definition PEqSeq : forall (n : ((@Num))), forall (a : Type), (((@PEq) (a))) -> ((@PEq) (((@seq) (n) (a)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (((@PEq) (a))) -> ((@PEq) (((@seq) (n_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PEqVec) (n_0)))) ((fun (a : Type) (pa : ((RecordTypeCons) ("eq") ((a) -> (a) -> ((@SAWCoreScaffolding.Bool))) (RecordTypeNil))) => ((@SAWCoreScaffolding.error) (((@PEq) (((@SAWCorePrelude.Stream) (a))))) (("invalid Eq instance")%string)))) (n))).
...
Definition PEqSeqBool : forall (n : ((@Num))), ((@PEq) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PEq) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PEqWord) (n_0)))) (((@SAWCoreScaffolding.error) (((@PEq) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("invalid Eq instance")%string))) (n))).
...
Definition PCmpSeq : forall (n : ((@Num))), forall (a : Type), (((@PCmp) (a))) -> ((@PCmp) (((@seq) (n) (a)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (((@PCmp) (a))) -> ((@PCmp) (((@seq) (n_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PCmpVec) (n_0)))) ((fun (a : Type) (pa : ((RecordTypeCons) ("cmp") ((a) -> (a) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) (((RecordTypeCons) ("cmpEq") (((RecordTypeCons) ("eq") ((a) -> (a) -> ((@SAWCoreScaffolding.Bool))) (RecordTypeNil))) (RecordTypeNil))))) => ((@SAWCoreScaffolding.error) (((@PCmp) (((@SAWCorePrelude.Stream) (a))))) (("invalid Cmp instance")%string)))) (n))).
...
Definition PCmpSeqBool : forall (n : ((@Num))), ((@PCmp) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PCmp) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PCmpWord) (n_0)))) (((@SAWCoreScaffolding.error) (((@PCmp) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("invalid Cmp instance")%string))) (n))).
...
Definition PSignedCmpSeq : forall (n : ((@Num))), forall (a : Type), (((@PSignedCmp) (a))) -> ((@PSignedCmp) (((@seq) (n) (a)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (((@PSignedCmp) (a))) -> ((@PSignedCmp) (((@seq) (n_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PSignedCmpVec) (n_0)))) ((fun (a : Type) (pa : ((RecordTypeCons) ("scmp") ((a) -> (a) -> (((@SAWCoreScaffolding.Bool))) -> ((@SAWCoreScaffolding.Bool))) (((RecordTypeCons) ("signedCmpEq") (((RecordTypeCons) ("eq") ((a) -> (a) -> ((@SAWCoreScaffolding.Bool))) (RecordTypeNil))) (RecordTypeNil))))) => ((@SAWCoreScaffolding.error) (((@PSignedCmp) (((@SAWCorePrelude.Stream) (a))))) (("invalid SignedCmp instance")%string)))) (n))).
...
Definition PSignedCmpSeqBool : forall (n : ((@Num))), ((@PSignedCmp) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PSignedCmp) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PSignedCmpWord) (n_0)))) (((@SAWCoreScaffolding.error) (((@PSignedCmp) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("invalid SignedCmp instance")%string))) (n))).
...
Definition PZeroSeqBool : forall (n : ((@Num))), ((@PZero) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PZero) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.bvNat) (n_0) (0)))) (((@SAWCorePrelude.streamConst) (((@SAWCoreScaffolding.Bool))) (((@SAWCoreScaffolding.false))))) (n))).
...
Definition PLogicSeq : forall (n : ((@Num))), forall (a : Type), (((@PLogic) (a))) -> ((@PLogic) (((@seq) (n) (a)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (((@PLogic) (a))) -> ((@PLogic) (((@seq) (n_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PLogicVec) (n_0)))) (((@PLogicStream))) (n))).
...
Definition PLogicSeqBool : forall (n : ((@Num))), ((@PLogic) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PLogic) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PLogicWord) (n_0)))) (((@PLogicStream) (((@SAWCoreScaffolding.Bool))) (((@PLogicBit))))) (n))).
...
Definition PRingSeq : forall (n : ((@Num))), forall (a : Type), (((@PRing) (a))) -> ((@PRing) (((@seq) (n) (a)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), (((@PRing) (a))) -> ((@PRing) (((@seq) (n_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PRingVec) (n_0)))) (((@PRingStream))) (n))).
...
Definition PRingSeqBool : forall (n : ((@Num))), ((@PRing) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PRing) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PRingWord) (n_0)))) (((@SAWCoreScaffolding.error) (((@PRing) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("PRingSeqBool: no instance for streams")%string))) (n))).

Definition PRingFun : forall (a : Type), forall (b : Type), (((@PRing) (b))) -> ((@PRing) ((a) -> b)) :=
  (fun (a : Type) (b : Type) (pb : ((RecordTypeCons) ("add") ((b) -> (b) -> b) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> b) (((RecordTypeCons) ("mul") ((b) -> (b) -> b) (((RecordTypeCons) ("neg") ((b) -> b) (((RecordTypeCons) ("ringZero") (b) (((RecordTypeCons) ("sub") ((b) -> (b) -> b) (RecordTypeNil))))))))))))) => ((RecordCons) ("add") (((@funBinary) (a) (b) (((RecordProj) (pb) ("add"))))) (((RecordCons) ("int") ((fun (i : ((@SAWCoreScaffolding.Integer))) (_ : a) => ((((RecordProj) (pb) ("int"))) (i)))) (((RecordCons) ("mul") (((@funBinary) (a) (b) (((RecordProj) (pb) ("mul"))))) (((RecordCons) ("neg") (((@compose) (a) (b) (b) (((RecordProj) (pb) ("neg"))))) (((RecordCons) ("ringZero") (((@PZeroFun) (a) (b) (((RecordProj) (pb) ("ringZero"))))) (((RecordCons) ("sub") (((@funBinary) (a) (b) (((RecordProj) (pb) ("sub"))))) (RecordNil))))))))))))).
...
Definition PIntegralSeqBool : forall (n : ((@Num))), ((@PIntegral) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PIntegral) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@PIntegralWord) (n_0)))) (((@SAWCoreScaffolding.error) (((@PIntegral) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("PIntegralSeqBool: no instance for streams")%string))) (n))).
...
Definition PLiteralSeqBool : forall (n : ((@Num))), ((@PLiteral) (((@seq) (n) (((@SAWCoreScaffolding.Bool)))))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => ((@PLiteral) (((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))))) (((@SAWCoreVectorsAsCoqVectors.bvNat))) (((@SAWCoreScaffolding.error) (((@PLiteral) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))))) (("PLiteralSeqBool: no instance for streams")%string))) (n))).
...
Definition ecFromZ : forall (n : ((@Num))), (((@IntModNum) (n))) -> ((@SAWCoreScaffolding.Integer)) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@IntModNum) (n_0))) -> ((@SAWCoreScaffolding.Integer)))) (((@SAWCoreScaffolding.fromIntMod))) ((fun (x : ((@SAWCoreScaffolding.Integer))) => x)) (n))).
...
Definition ecLg2 : forall (n : ((@Num))), (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n) (((@SAWCoreScaffolding.Bool)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@seq) (n_0) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCoreVectorsAsCoqVectors.bvLg2))) (((@SAWCoreScaffolding.error) ((((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) (("ecLg2: expected finite word")%string))) (n))).

Definition ecSDiv : forall (n : ((@Num))), (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n) (((@SAWCoreScaffolding.Bool)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@seq) (n_0) (((@SAWCoreScaffolding.Bool))))) -> (((@seq) (n_0) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCorePrelude.Nat__rec) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCoreScaffolding.error) ((((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) (("ecSDiv: illegal 0-width word")%string))) ((fun (n' : ((@SAWCoreScaffolding.Nat))) (_ : (((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) => ((@SAWCoreVectorsAsCoqVectors.bvSDiv) (n')))))) (((@SAWCoreScaffolding.error) ((((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) (("ecSDiv: expected finite word")%string))) (n))).

Definition ecSMod : forall (n : ((@Num))), (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> (((@seq) (n) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n) (((@SAWCoreScaffolding.Bool)))) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@seq) (n_0) (((@SAWCoreScaffolding.Bool))))) -> (((@seq) (n_0) (((@SAWCoreScaffolding.Bool))))) -> ((@seq) (n_0) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCorePrelude.Nat__rec) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCoreScaffolding.error) ((((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (0) (((@SAWCoreScaffolding.Bool))))) (("ecSMod: illegal 0-width word")%string))) ((fun (n' : ((@SAWCoreScaffolding.Nat))) (_ : (((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n') (((@SAWCoreScaffolding.Bool))))) => ((@SAWCoreVectorsAsCoqVectors.bvSRem) (n')))))) (((@SAWCoreScaffolding.error) ((((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) -> (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) -> ((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) (("ecSMod: expected finite word")%string))) (n))).
...
Definition ecTranspose : forall (m : ((@Num))), forall (n : ((@Num))), forall (a : Type), (((@seq) (m) (((@seq) (n) (a))))) -> ((@seq) (n) (((@seq) (m) (a)))) :=
  (fun (m : ((@Num))) (n : ((@Num))) (a : Type) => ((CryptolPrimitives.Num_rect) ((fun (m_0 : ((@Num))) => (((@seq) (m_0) (((@seq) (n) (a))))) -> ((@seq) (n) (((@seq) (m_0) (a)))))) ((fun (m_0 : ((@SAWCoreScaffolding.Nat))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (((@seq) (n_0) (a))))) -> ((@seq) (n_0) (((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.transpose) (m_0) (n_0) (a)))) ((fun (xss : ((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (((@SAWCorePrelude.Stream) (a))))) => ((@SAWCorePrelude.MkStream) (((@SAWCoreVectorsAsCoqVectors.Vec) (m_0) (a))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.gen) (m_0) (a) ((fun (j : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.streamGet) (a) (((@SAWCorePrelude.sawAt) (m_0) (((@SAWCorePrelude.Stream) (a))) (xss) (j))) (i)))))))))) (n)))) (((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => (((@SAWCorePrelude.Stream) (((@seq) (n_0) (a))))) -> ((@seq) (n_0) (((@SAWCorePrelude.Stream) (a)))))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (xss : ((@SAWCorePrelude.Stream) (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))))) => ((@SAWCoreVectorsAsCoqVectors.gen) (n_0) (((@SAWCorePrelude.Stream) (a))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.MkStream) (a) ((fun (j : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.sawAt) (n_0) (a) (((@SAWCorePrelude.streamGet) (((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))) (xss) (j))) (i)))))))))) ((fun (xss : ((@SAWCorePrelude.Stream) (((@SAWCorePrelude.Stream) (a))))) => ((@SAWCorePrelude.MkStream) (((@SAWCorePrelude.Stream) (a))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.MkStream) (a) ((fun (j : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.streamGet) (a) (((@SAWCorePrelude.streamGet) (((@SAWCorePrelude.Stream) (a))) (xss) (j))) (i)))))))))) (n))) (m))).

Definition ecAt : forall (n : ((@Num))), forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n) (a))) -> (ix) -> a :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n_0) (a))) -> (ix) -> a)) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))) => ((((RecordProj) (pix) ("posNegCases"))) (a) (((@SAWCorePrelude.sawAt) (n_0) (a) (xs))) ((fun (_ : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.sawAt) (n_0) (a) (xs) (0))))))) ((fun (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((@SAWCorePrelude.Stream) (a))) => ((((RecordProj) (pix) ("posNegCases"))) (a) (((@SAWCorePrelude.streamGet) (a) (xs))) ((fun (_ : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.streamGet) (a) (xs) (0))))))) (n))).

Definition ecAtBack : forall (n : ((@Num))), forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n) (a))) -> (ix) -> a :=
  (fun (n : ((@Num))) (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((CryptolPrimitives.Num_rect) ((fun (num : ((@Num))) => Type)) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a)))) (((@SAWCorePrelude.Stream) (a))) (n))) => ((@ecAt) (n) (a) (ix) (pix) (((@ecReverse) (n) (a) (xs))))).
...
Definition ecTrace : forall (n : ((@Num))), forall (a : Type), forall (b : Type), (((@seq) (n) (((@SAWCorePrelude.bitvector) (8))))) -> (a) -> (b) -> b :=
  (fun (_ : ((@Num))) (__0 : Type) (__1 : Type) (__2 : ((CryptolPrimitives.Num_rect) ((fun (num : ((@Num))) => Type)) ((fun (n : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCorePrelude.bitvector) (8)))))) (((@SAWCorePrelude.Stream) (((@SAWCorePrelude.bitvector) (8))))) (_))) (__3 : __0) (x : __1) => x).

Definition TCFloat : (((@Num))) -> (((@Num))) -> Type :=
  (fun (_ : ((@Num))) (__0 : ((@Num))) => unit).
...
Definition ecFpFromBits : forall (e : ((@Num))), forall (p : ((@Num))), (((@seq) (((@tcAdd) (e) (p))) (((@SAWCoreScaffolding.Bool))))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((CryptolPrimitives.Num_rect) ((fun (num : ((@Num))) => Type)) ((fun (n : ((@SAWCoreScaffolding.Nat))) => ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (((@SAWCoreScaffolding.Bool)))))) (((@SAWCorePrelude.Stream) (((@SAWCoreScaffolding.Bool))))) (((CryptolPrimitives.Num_rect) ((fun (num1' : ((@Num))) => ((@Num)))) ((fun (n1 : ((@SAWCoreScaffolding.Nat))) => ((CryptolPrimitives.Num_rect) ((fun (num2' : ((@Num))) => ((@Num)))) ((fun (n2 : ((@SAWCoreScaffolding.Nat))) => ((@TCNum) (((@SAWCorePrelude.addNat) (n1) (n2)))))) ((((fun (x : ((@SAWCoreScaffolding.Nat))) => ((@TCInf)))) (n1))) (p)))) (((CryptolPrimitives.Num_rect) ((fun (num2' : ((@Num))) => ((@Num)))) ((fun (y : ((@SAWCoreScaffolding.Nat))) => ((@TCInf)))) (((@TCInf))) (p))) (e))))) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpFromBits")%string))).

Definition ecFpToBits : forall (e : ((@Num))), forall (p : ((@Num))), (((@TCFloat) (e) (p))) -> ((@seq) (((@tcAdd) (e) (p))) (((@SAWCoreScaffolding.Bool)))) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : unit) => ((@SAWCoreScaffolding.error) (((@seq) (((@tcAdd) (e) (p))) (((@SAWCoreScaffolding.Bool))))) (("Unimplemented: fpToBits")%string))).

Definition ecFpEq : forall (e : ((@Num))), forall (p : ((@Num))), (((@TCFloat) (e) (p))) -> (((@TCFloat) (e) (p))) -> ((@SAWCoreScaffolding.Bool)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : unit) (__0 : unit) => ((@SAWCoreScaffolding.error) (((@SAWCoreScaffolding.Bool))) (("Unimplemented: =.=")%string))).

Definition ecFpAdd : forall (e : ((@Num))), forall (p : ((@Num))), (((@SAWCorePrelude.bitvector) (3))) -> (((@TCFloat) (e) (p))) -> (((@TCFloat) (e) (p))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((@SAWCoreVectorsAsCoqVectors.Vec) (3) (((@SAWCoreScaffolding.Bool))))) (__0 : unit) (__1 : unit) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpAdd")%string))).

Definition ecFpSub : forall (e : ((@Num))), forall (p : ((@Num))), (((@SAWCorePrelude.bitvector) (3))) -> (((@TCFloat) (e) (p))) -> (((@TCFloat) (e) (p))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((@SAWCoreVectorsAsCoqVectors.Vec) (3) (((@SAWCoreScaffolding.Bool))))) (__0 : unit) (__1 : unit) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpSub")%string))).

Definition ecFpMul : forall (e : ((@Num))), forall (p : ((@Num))), (((@SAWCorePrelude.bitvector) (3))) -> (((@TCFloat) (e) (p))) -> (((@TCFloat) (e) (p))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((@SAWCoreVectorsAsCoqVectors.Vec) (3) (((@SAWCoreScaffolding.Bool))))) (__0 : unit) (__1 : unit) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpMul")%string))).

Definition ecFpDiv : forall (e : ((@Num))), forall (p : ((@Num))), (((@SAWCorePrelude.bitvector) (3))) -> (((@TCFloat) (e) (p))) -> (((@TCFloat) (e) (p))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((@SAWCoreVectorsAsCoqVectors.Vec) (3) (((@SAWCoreScaffolding.Bool))))) (__0 : unit) (__1 : unit) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpDiv")%string))).

Definition ecFpIsFinite : forall (e : ((@Num))), forall (p : ((@Num))), (((@TCFloat) (e) (p))) -> ((@SAWCoreScaffolding.Bool)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : unit) => ((@SAWCoreScaffolding.error) (((@SAWCoreScaffolding.Bool))) (("Unimplemented: fpIsFinite")%string))).

Definition ecFpToRational : forall (e : ((@Num))), forall (p : ((@Num))), (((@TCFloat) (e) (p))) -> ((@Rational)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : unit) => ((@SAWCoreScaffolding.error) (((@Rational))) (("Unimplemented: fpToRational")%string))).

Definition ecFpFromRational : forall (e : ((@Num))), forall (p : ((@Num))), (((@SAWCorePrelude.bitvector) (3))) -> (((@Rational))) -> ((@TCFloat) (e) (p)) :=
  (fun (e : ((@Num))) (p : ((@Num))) (_ : ((@SAWCoreVectorsAsCoqVectors.Vec) (3) (((@SAWCoreScaffolding.Bool))))) (__0 : unit) => ((@SAWCoreScaffolding.error) (((@TCFloat) (e) (p))) (("Unimplemented: fpFromRational")%string))).

Definition ecUpdate : forall (n : ((@Num))), forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n) (a))) -> (ix) -> (a) -> ((@seq) (n) (a)) :=
  (fun (n : ((@Num))) => ((CryptolPrimitives.Num_rect) ((fun (n_0 : ((@Num))) => forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n_0) (a))) -> (ix) -> (a) -> ((@seq) (n_0) (a)))) ((fun (n_0 : ((@SAWCoreScaffolding.Nat))) (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))) => ((((RecordProj) (pix) ("posNegCases"))) ((a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n_0) (a))) (((@SAWCorePrelude.upd) (n_0) (a) (xs))) ((fun (_ : ((@SAWCoreScaffolding.Nat))) (__0 : a) => xs))))) ((fun (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((@SAWCorePrelude.Stream) (a))) => ((((RecordProj) (pix) ("posNegCases"))) ((a) -> ((@SAWCorePrelude.Stream) (a))) (((@SAWCorePrelude.streamUpd) (a) (xs))) ((fun (_ : ((@SAWCoreScaffolding.Nat))) (__0 : a) => xs))))) (n))).

Definition ecUpdateEnd : forall (n : ((@Num))), forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n) (a))) -> (ix) -> (a) -> ((@seq) (n) (a)) :=
  ((@finNumRec) ((fun (n : ((@Num))) => forall (a : Type), forall (ix : Type), (((@PIntegral) (ix))) -> (((@seq) (n) (a))) -> (ix) -> (a) -> ((@seq) (n) (a)))) ((fun (n : ((@SAWCoreScaffolding.Nat))) (a : Type) (ix : Type) (pix : ((RecordTypeCons) ("div") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("integralRing") (((RecordTypeCons) ("add") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("int") ((((@SAWCoreScaffolding.Integer))) -> ix) (((RecordTypeCons) ("mul") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("neg") ((ix) -> ix) (((RecordTypeCons) ("ringZero") (ix) (((RecordTypeCons) ("sub") ((ix) -> (ix) -> ix) (RecordTypeNil))))))))))))) (((RecordTypeCons) ("mod") ((ix) -> (ix) -> ix) (((RecordTypeCons) ("posNegCases") (forall (r : Type), ((((@SAWCoreScaffolding.Nat))) -> r) -> ((((@SAWCoreScaffolding.Nat))) -> r) -> (ix) -> r) (((RecordTypeCons) ("toInt") ((ix) -> ((@SAWCoreScaffolding.Integer))) (RecordTypeNil))))))))))) (xs : ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) => ((((RecordProj) (pix) ("posNegCases"))) ((a) -> ((@SAWCoreVectorsAsCoqVectors.Vec) (n) (a))) ((fun (i : ((@SAWCoreScaffolding.Nat))) => ((@SAWCorePrelude.upd) (n) (a) (xs) (((@SAWCorePrelude.subNat) (((@SAWCorePrelude.subNat) (n) (1))) (i)))))) ((fun (_ : ((@SAWCoreScaffolding.Nat))) (__0 : a) => xs)))))).
