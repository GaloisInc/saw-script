...
define dso_local i32 @h(i32 %0) local_unnamed_addr #0 !dbg !36 {
  ...
  call void @llvm.dbg.value(metadata i32 %0, metadata !16, metadata !DIExpression()), !dbg !40
  %2 = load i32, i32* @x, align 4, !dbg !42, !tbaa !19
  call void @llvm.dbg.value(metadata i32 undef, metadata !29, metadata !DIExpression()), !dbg !43
  %3 = add i32 %2, 3, !dbg !45
  store i32 %3, i32* @x, align 4, !dbg !46, !tbaa !19
  %4 = add i32 %0, 1, !dbg !47
  %5 = add i32 %4, %2, !dbg !48
  %6 = add i32 %5, %3, !dbg !49
  ret i32 %6, !dbg !50
}
...
!11 = !{!"/usr/lib/llvm-10/bin/clang -g -emit-llvm -frecord-command-line -O2 -S test.c -o test-O2.ll"}
...
!41 = distinct !DILocation(line: 14, column: 12, scope: !36)
!42 = !DILocation(line: 4, column: 7, scope: !12, inlinedAt: !41)
!43 = !DILocation(line: 0, scope: !27, inlinedAt: !44)
!44 = distinct !DILocation(line: 14, column: 10, scope: !36)
!45 = !DILocation(line: 9, column: 9, scope: !27, inlinedAt: !44)
!46 = !DILocation(line: 9, column: 5, scope: !27, inlinedAt: !44)
!47 = !DILocation(line: 4, column: 9, scope: !12, inlinedAt: !41)
!48 = !DILocation(line: 5, column: 12, scope: !12, inlinedAt: !41)
!49 = !DILocation(line: 10, column: 12, scope: !27, inlinedAt: !44)
!50 = !DILocation(line: 14, column: 3, scope: !36)
