...
PUBLIC_GITHUB_REPOS="crucible cryptol aig abcBridge jvm-parser llvm-pretty llvm-pretty-bc-parser parameterized-utils saw-core saw-core-aig saw-core-sbv cryptol-verifier jvm-verifier llvm-verifier golang anastasia"
