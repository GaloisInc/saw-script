/-
Combinational attack: build `Eq Type Bool Empty` via unsafeAssert
...
combinational attack a regression alarm, not a silent unsoundness.

Pinned by the 2026-05-04 attack-surface inventory:
  saw-core-lean/doc/2026-05-04_attack-surface.md
...
noncomputable def attackCoerceUnsafeAssert : False := by
