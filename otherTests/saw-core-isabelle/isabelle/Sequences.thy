...
cryptol_definition all_as_fold :: "{'n,'a} ((fin 'n,Eq 'a) =?> (('a \<Rightarrow> Bit) \<Rightarrow> ((['n]'a) \<Rightarrow> Bit)))" where
...
cryptol_definition any_as_fold :: "{'n,'a} ((fin 'n,Eq 'a) =?> (('a \<Rightarrow> Bit) \<Rightarrow> ((['n]'a) \<Rightarrow> Bit)))" where
...
cryptol_definition butlast :: "{'n,'a} ((fin 'n,Eq 'a) =?> (([1 + 'n]'a) \<Rightarrow> (['n]'a)))" where
...
cryptol_definition foldl_valid :: "{'n,'k,'a,'b} ((fin 'n,'k < 'n,Eq 'a,Eq 'b) =?> (('a \<Rightarrow> ('b \<Rightarrow> 'a)) \<Rightarrow> ('a \<Rightarrow> ((['n]'b) \<Rightarrow> Bit))))" where
"foldl_valid f x xs \<equiv> (foldl`{'n,'a,'b} f x xs) ==`{'a} (foldl`{'n - 'k,'a,'b} f (foldl`{'k,'a,'b} f x (take`{'k,'n - 'k,'b} xs)) (drop`{'k,'n - 'k,'b} xs))"

cryptol_definition foldr_valid :: "{'n,'k,'a,'b} ((fin 'n,'k < 'n,Eq 'b,Eq 'a) =?> (('a \<Rightarrow> ('b \<Rightarrow> 'b)) \<Rightarrow> ('b \<Rightarrow> ((['n]'a) \<Rightarrow> Bit))))" where
...
cryptol_definition map_valid :: "{'n,'a,'b} ((fin 'n,Eq 'b,Eq 'a) =?> (('a \<Rightarrow> 'b) \<Rightarrow> ((['n]'a) \<Rightarrow> Bit)))" where
...
cryptol_definition scanl_valid :: "{'n,'k,'a,'b} ((fin 'n,'k < 'n,Eq 'b,Eq 'a) =?> (('b \<Rightarrow> ('a \<Rightarrow> 'b)) \<Rightarrow> ('b \<Rightarrow> ((['n]'a) \<Rightarrow> Bit))))" where
...
cryptol_definition scanr_valid :: "{'n,'k,'a,'b} ((fin 'n,'k < 'n,Eq 'b,Eq 'a) =?> (('a \<Rightarrow> ('b \<Rightarrow> 'b)) \<Rightarrow> ('b \<Rightarrow> ((['n]'a) \<Rightarrow> Bit))))" where
...
cryptol_definition take_append :: "{'front,'back,'a} ((fin 'front,Eq 'a,fin 'back) =?> ((['front]'a) \<Rightarrow> ((['back]'a) \<Rightarrow> Bit)))" where
...
cryptol_definition zipWith_as_map :: "{'n,'a,'b,'c} ((fin 'n,Eq 'c,Eq 'a,Eq 'b) =?> (('a \<Rightarrow> ('b \<Rightarrow> 'c)) \<Rightarrow> ((['n]'a) \<Rightarrow> ((['n]'b) \<Rightarrow> Bit))))" where
