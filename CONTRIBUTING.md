...
[doc/internal/developer.md](doc/internal/developer.md).
...
(as noted in README.md) and also a copy of the version of Rust compiler
that `mir-json` supports.
See the
...
Finally, to run the full set of integration tets you will need a full
...
see [doc/internal/developer.md](doc/internal/developer.md#Testing) for
a rundown.
...
[doc/internal/issue-labels.md](doc/internal/issue-labels.md).
...
Developer-facing documentation includes assorted other READMEs and
change logs, the [saw-remote-api/docs](remote API documentation),
this file, its supplements [doc/internal/developer.md](developer.md)
...
[doc/internal/developer.md](developer.md) for developer-facing,
...
hard to read or the grammar is half in Mandarin or whatever -- it is
...
[doc/internal/developer.md](doc/internal/developer.md#Git).
...
See [doc/internal/developer.md](doc/internal/developer.md#Releases).
...
- Pull requests should be merged by "merge", not "rebase" or
  ...
  contentious) topic.
  For discussion, see 
  [doc/internal/developer.md](doc/internal/developer.md#Rebasing).
...
See [doc/internal/developer.md](doc/internal/developer.md#Rebasing)
for discussion.)
