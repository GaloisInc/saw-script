...
-- | A 'BigFloat' paired with the number of bits used for its exponent
-- ('fofExp') and precision/significand ('fofPrec'). It is convenient to define
-- this as its own data type for the sake of giving it a 'ToJSON' instance.
