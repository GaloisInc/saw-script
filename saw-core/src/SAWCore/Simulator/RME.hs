...
type instance VFloat ReedMuller = ()
...
prims =
  ...
  , Prims.bpMuxFloat = unsupportedRMEPrimitive "bpMuxFloat"
  ...
  , Prims.bpNatToInt = pure1 toInteger
    -- Float operations
  , Prims.bpFpAbs = unsupportedRMEPrimitive "bpFpAbs"
  , Prims.bpFpAdd = unsupportedRMEPrimitive "bpFpAdd"
  , Prims.bpFpCast = unsupportedRMEPrimitive "bpFpCast"
  , Prims.bpFpDiv = unsupportedRMEPrimitive "bpFpDiv"
  , Prims.bpFpFMA = unsupportedRMEPrimitive "bpFpFMA"
  , Prims.bpFpFromBits = unsupportedRMEPrimitive "bpFpFromBits"
  , Prims.bpFpFromBV = unsupportedRMEPrimitive "bpFpFromBV"
  , Prims.bpFpFromInteger = unsupportedRMEPrimitive "bpFpFromInteger"
  , Prims.bpFpFromRational = unsupportedRMEPrimitive "bpFpFromRational"
  , Prims.bpFpFromSBV = unsupportedRMEPrimitive "bpFpFromSBV"
  , Prims.bpFpIeeeEq = unsupportedRMEPrimitive "bpFpIeeeEq"
  , Prims.bpFpIsInf = unsupportedRMEPrimitive "bpFpIsInf"
  , Prims.bpFpIsNaN = unsupportedRMEPrimitive "bpFpIsNaN"
  , Prims.bpFpIsNeg = unsupportedRMEPrimitive "bpFpIsNeg"
  , Prims.bpFpIsNormal = unsupportedRMEPrimitive "bpFpIsNormal"
  , Prims.bpFpIsPos = unsupportedRMEPrimitive "bpFpIsPos"
  , Prims.bpFpIsSubnormal = unsupportedRMEPrimitive "bpFpIsSubnormal"
  , Prims.bpFpIsZero = unsupportedRMEPrimitive "bpFpIsZero"
  , Prims.bpFpLt = unsupportedRMEPrimitive "bpFpLt"
  , Prims.bpFpLogicalEq = unsupportedRMEPrimitive "bpFpLogicalEq"
  , Prims.bpFpMul = unsupportedRMEPrimitive "bpFpMul"
  , Prims.bpFpNaN = unsupportedRMEPrimitive "bpFpNaN"
  , Prims.bpFpNeg = unsupportedRMEPrimitive "bpFpNeg"
  , Prims.bpFpPosInf = unsupportedRMEPrimitive "bpFpPosInf"
  , Prims.bpFpPosZero = unsupportedRMEPrimitive "bpFpPosZero"
  , Prims.bpFpRem = unsupportedRMEPrimitive "bpFpRem"
  , Prims.bpFpRound = unsupportedRMEPrimitive "bpFpRound"
  , Prims.bpFpSqrt = unsupportedRMEPrimitive "bpFpSqrt"
  , Prims.bpFpSub = unsupportedRMEPrimitive "bpFpSub"
  , Prims.bpFpToBits = unsupportedRMEPrimitive "bpFpToBits"
  , Prims.bpFpToBV = unsupportedRMEPrimitive "bpFpToBV"
  , Prims.bpFpToInteger = unsupportedRMEPrimitive "bpFpToInteger"
  , Prims.bpFpToRational = unsupportedRMEPrimitive "bpFpToRational"
  , Prims.bpFpToSBV = unsupportedRMEPrimitive "bpFpToSBV"
    -- Array operations
