...
natFun = PrimFilterFun "expected Nat" r
  where r (VNat n) = pure n
        r (VCtorApp (primName -> "sawcore:Prelude.Zero") [] [])  = pure 0
        r (VCtorApp (primName -> "sawcore:Prelude.Succ") [] [x]) = succ <$> (r =<< lift (force x))
        r _ = mzero
...
constMap bp = Map.fromList
  -- Boolean
  [ ("sawcore:Prelude.Bool"  , PrimValue (TValue VBoolType))
  , ("sawcore:Prelude.True"  , PrimValue (VBool (bpTrue bp)))
  , ("sawcore:Prelude.False" , PrimValue (VBool (bpFalse bp)))
  , ("sawcore:Prelude.not"   , boolFun (Prim . liftM VBool . bpNot bp))
  , ("sawcore:Prelude.and"   , boolBinOp (bpAnd bp))
  , ("sawcore:Prelude.or"    , boolBinOp (bpOr bp))
  , ("sawcore:Prelude.xor"   , boolBinOp (bpXor bp))
  , ("sawcore:Prelude.boolEq", boolBinOp (bpBoolEq bp))
  -- Bitwise
  , ("sawcore:Prelude.bvAnd" , wordBinOp (bpPack bp) (bpBvAnd bp))
  , ("sawcore:Prelude.bvOr"  , wordBinOp (bpPack bp) (bpBvOr  bp))
  , ("sawcore:Prelude.bvXor" , wordBinOp (bpPack bp) (bpBvXor bp))
  , ("sawcore:Prelude.bvNot" , wordUnOp  (bpPack bp) (bpBvNot bp))
  -- Arithmetic
  , ("sawcore:Prelude.bvNeg" , wordUnOp  (bpPack bp) (bpBvNeg bp))
  , ("sawcore:Prelude.bvAdd" , wordBinOp (bpPack bp) (bpBvAdd bp))
  , ("sawcore:Prelude.bvSub" , wordBinOp (bpPack bp) (bpBvSub bp))
  , ("sawcore:Prelude.bvMul" , wordBinOp (bpPack bp) (bpBvMul bp))
  , ("sawcore:Prelude.bvUDiv", wordBinOp (bpPack bp) (bpBvUDiv bp))
  , ("sawcore:Prelude.bvURem", wordBinOp (bpPack bp) (bpBvURem bp))
  , ("sawcore:Prelude.bvSDiv", wordBinOp (bpPack bp) (bpBvSDiv bp))
  , ("sawcore:Prelude.bvSRem", wordBinOp (bpPack bp) (bpBvSRem bp))
  , ("sawcore:Prelude.bvLg2" , wordUnOp  (bpPack bp) (bpBvLg2  bp))
  -- Comparisons
  , ("sawcore:Prelude.bvEq"  , wordBinRel (bpPack bp) (bpBvEq  bp))
  , ("sawcore:Prelude.bvsle" , wordBinRel (bpPack bp) (bpBvsle bp))
  , ("sawcore:Prelude.bvslt" , wordBinRel (bpPack bp) (bpBvslt bp))
  , ("sawcore:Prelude.bvule" , wordBinRel (bpPack bp) (bpBvule bp))
  , ("sawcore:Prelude.bvult" , wordBinRel (bpPack bp) (bpBvult bp))
  , ("sawcore:Prelude.bvsge" , wordBinRel (bpPack bp) (bpBvsge bp))
  , ("sawcore:Prelude.bvsgt" , wordBinRel (bpPack bp) (bpBvsgt bp))
  , ("sawcore:Prelude.bvuge" , wordBinRel (bpPack bp) (bpBvuge bp))
  , ("sawcore:Prelude.bvugt" , wordBinRel (bpPack bp) (bpBvugt bp))
    -- Bitvector misc
  , ("sawcore:Prelude.bvPopcount", wordUnOp (bpPack bp) (bpBvPopcount bp))
  , ("sawcore:Prelude.bvCountLeadingZeros", wordUnOp (bpPack bp) (bpBvCountLeadingZeros bp))
  , ("sawcore:Prelude.bvCountTrailingZeros", wordUnOp (bpPack bp) (bpBvCountTrailingZeros bp))
  , ("sawcore:Prelude.bvForall",
        natFun $ \n ->
        strictFun $ \f ->
  ...
  -- Nat
  , ("sawcore:Prelude.Succ", succOp bp)
  , ("sawcore:Prelude.addNat", addNatOp bp)
  , ("sawcore:Prelude.subNat", subNatOp bp)
  , ("sawcore:Prelude.mulNat", mulNatOp bp)
  , ("sawcore:Prelude.minNat", minNatOp bp)
  , ("sawcore:Prelude.maxNat", maxNatOp bp)
  , ("sawcore:Prelude.divModNat", divModNatOp bp)
  , ("sawcore:Prelude.expNat", expNatOp)
  , ("sawcore:Prelude.widthNat", widthNatOp)
  , ("sawcore:Prelude.natCase", natCaseOp)
  , ("sawcore:Prelude.equalNat", equalNatOp bp)
  , ("sawcore:Prelude.ltNat", ltNatOp bp)
  -- Integers
  , ("sawcore:Prelude.Integer", PrimValue (TValue VIntType))
  , ("sawcore:Prelude.intAdd", intBinOp (bpIntAdd bp))
  , ("sawcore:Prelude.intSub", intBinOp (bpIntSub bp))
  , ("sawcore:Prelude.intMul", intBinOp (bpIntMul bp))
  , ("sawcore:Prelude.intDiv", intBinOp (bpIntDiv bp))
  , ("sawcore:Prelude.intMod", intBinOp (bpIntMod bp))
  , ("sawcore:Prelude.intNeg", intUnOp  (bpIntNeg bp))
  , ("sawcore:Prelude.intAbs", intUnOp  (bpIntAbs bp))
  , ("sawcore:Prelude.intEq" , intBinCmp (bpIntEq bp))
  , ("sawcore:Prelude.intLe" , intBinCmp (bpIntLe bp))
  , ("sawcore:Prelude.intLt" , intBinCmp (bpIntLt bp))
  , ("sawcore:Prelude.intMin", intBinOp (bpIntMin bp))
  , ("sawcore:Prelude.intMax", intBinOp (bpIntMax bp))
  -- Modular Integers
  , ("sawcore:Prelude.IntMod", natFun $ \n -> PrimValue (TValue (VIntModType n)))
  -- Vectors
  , ("sawcore:Prelude.Vec", vecTypeOp)
  , ("sawcore:Prelude.gen", genOp)
  , ("sawcore:Prelude.head", headOp bp)
  , ("sawcore:Prelude.tail", tailOp bp)
  , ("sawcore:Prelude.atWithDefault", atWithDefaultOp bp)
  , ("sawcore:Prelude.upd", updOp bp)
  , ("sawcore:Prelude.take", takeOp bp)
  , ("sawcore:Prelude.drop", dropOp bp)
  , ("sawcore:Prelude.append", appendOp bp)
  , ("sawcore:Prelude.join", joinOp bp)
  , ("sawcore:Prelude.split", splitOp bp)
  , ("sawcore:Prelude.zip", vZipOp (bpUnpack bp))
  , ("sawcore:Prelude.foldr", foldrOp (bpUnpack bp))
  , ("sawcore:Prelude.foldl", foldlOp (bpUnpack bp))
  , ("sawcore:Prelude.scanl", scanlOp (bpUnpack bp))
  , ("sawcore:Prelude.rotateL", rotateLOp bp)
  , ("sawcore:Prelude.rotateR", rotateROp bp)
  , ("sawcore:Prelude.shiftL", shiftLOp bp)
  , ("sawcore:Prelude.shiftR", shiftROp bp)
  , ("sawcore:Prelude.EmptyVec", emptyVec)
  -- Miscellaneous
  , ("sawcore:Prelude.coerce", coerceOp)
  , ("sawcore:Prelude.bvNat", bvNatOp bp)
  , ("sawcore:Prelude.bvToNat", bvToNatOp)
  , ("sawcore:Prelude.fix", fixOp)
  , ("sawcore:Prelude.error", errorOp)

  -- Strings
  , ("sawcore:Prelude.String", PrimValue (TValue VStringType))
  , ("sawcore:Prelude.appendString", appendStringOp)
  , ("sawcore:Prelude.bytesToString", bytesToStringOp bp)
  , ("sawcore:Prelude.equalString", equalStringOp bp)

  -- Overloaded
  , ("sawcore:Prelude.ite", iteOp bp)
  , ("sawcore:Prelude.iteDep", iteDepOp bp)
  -- SMT Arrays
  , ("sawcore:Prelude.Array", arrayTypeOp)
  , ("sawcore:Prelude.arrayConstant", arrayConstantOp bp)
  , ("sawcore:Prelude.arrayLookup", arrayLookupOp bp)
  , ("sawcore:Prelude.arrayUpdate", arrayUpdateOp bp)
  , ("sawcore:Prelude.arrayEq", arrayEqOp bp)
  , ("sawcore:Prelude.arrayCopy", arrayCopyOp bp)
  , ("sawcore:Prelude.arraySet", arraySetOp bp)
  , ("sawcore:Prelude.arrayRangeEq", arrayRangeEqOp bp)
  ]
...
natSizeFun = PrimFilterFun "expected Nat with a known size" r
  where r (VNat n) = pure (Right n)
        r (VCtorApp (primName -> "sawcore:Prelude.Zero") [] []) = pure (Right 0)
        r v@(VCtorApp (primName -> "sawcore:Prelude.Succ") [] [x]) =
