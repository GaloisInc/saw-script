...
Definition eitherCong0 : forall (t : Type), forall (x : Type), forall (y : Type), SAWCoreScaffolding.Eq Type x y -> let var__0   := forall (s : Type), forall (t1 : Type), Type in
  SAWCoreScaffolding.Eq Type (Either x t) (Either y t) :=
  fun (t : Type) (x : Type) (y : Type) (eq : SAWCoreScaffolding.Eq Type x y) => eq_cong Type x y eq Type (fun (y' : Type) => Either y' t).

Definition eitherCong1 : forall (t : Type), forall (x : Type), forall (y : Type), SAWCoreScaffolding.Eq Type x y -> let var__0   := forall (s : Type), forall (t1 : Type), Type in
  SAWCoreScaffolding.Eq Type (Either t x) (Either t y) :=
...
Definition eqNatSucc : forall (x : SAWCoreScaffolding.Nat), forall (y : SAWCoreScaffolding.Nat), eqNat x y -> let var__0   := SAWCoreScaffolding.Nat -> SAWCoreScaffolding.Nat in
  eqNat (SAWCoreScaffolding.Succ x) (SAWCoreScaffolding.Succ y) :=
...
Definition eqNatAddS : forall (x : SAWCoreScaffolding.Nat), forall (y : SAWCoreScaffolding.Nat), let var__0   := SAWCoreScaffolding.Nat -> SAWCoreScaffolding.Nat in
  eqNat (addNat x (SAWCoreScaffolding.Succ y)) (SAWCoreScaffolding.Succ (addNat x y)) :=
  fun (x : SAWCoreScaffolding.Nat) (y : SAWCoreScaffolding.Nat) => Nat__rec (fun (x' : SAWCoreScaffolding.Nat) => forall (y' : SAWCoreScaffolding.Nat), let var__0   := SAWCoreScaffolding.Nat -> SAWCoreScaffolding.Nat in
  eqNat (addNat x' (SAWCoreScaffolding.Succ y')) (SAWCoreScaffolding.Succ (addNat x' y'))) (fun (y' : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Refl SAWCoreScaffolding.Nat (SAWCoreScaffolding.Succ y')) (fun (x' : SAWCoreScaffolding.Nat) (eqF : forall (y' : SAWCoreScaffolding.Nat), let var__0   := SAWCoreScaffolding.Nat -> SAWCoreScaffolding.Nat in
  SAWCoreScaffolding.Eq SAWCoreScaffolding.Nat (SAWCoreScaffolding.Nat_rect (fun (n : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Nat) (SAWCoreScaffolding.Succ y') (fun (_1 : SAWCoreScaffolding.Nat) (prev_sum : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Succ prev_sum) x') (SAWCoreScaffolding.Succ (addNat x' y'))) (y' : SAWCoreScaffolding.Nat) => eqNatSucc (addNat x' (SAWCoreScaffolding.Succ y')) (SAWCoreScaffolding.Succ (addNat x' y')) (eqF y')) x y.
...
Definition eqNatAddComm : forall (x : SAWCoreScaffolding.Nat), forall (y : SAWCoreScaffolding.Nat), eqNat (addNat x y) (addNat y x) :=
  ...
  let var__1   := SAWCoreScaffolding.Nat -> Type in
  let var__2   := fun (n : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Nat in
  let var__3   := var__2 0 in
  let var__4   := forall (n : SAWCoreScaffolding.Nat), var__2 n -> (fun (n1 : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Nat) (SAWCoreScaffolding.Succ n) in
  let var__5   := fun (_1 : SAWCoreScaffolding.Nat) (prev_sum : SAWCoreScaffolding.Nat) => SAWCoreScaffolding.Succ prev_sum in
  SAWCoreScaffolding.Eq SAWCoreScaffolding.Nat (SAWCoreScaffolding.Nat_rect var__2 y' var__5 x') (SAWCoreScaffolding.Nat_rect var__2 x' var__5 y')) (x' : SAWCoreScaffolding.Nat) => trans SAWCoreScaffolding.Nat (addNat x' (SAWCoreScaffolding.Succ y')) (SAWCoreScaffolding.Succ (addNat x' y')) (SAWCoreScaffolding.Succ (addNat y' x')) (eqNatAddS x' y') (eqNatSucc (addNat x' y') (addNat y' x') (eqF x'))) y x.
...
Definition streamJoin : forall (a : Type), forall {Inh_a : SAWCoreScaffolding.Inhabited a}, forall (n : SAWCoreScaffolding.Nat), Stream (SAWCoreVectorsAsCoqVectors.Vec (SAWCoreScaffolding.Succ n) a) -> Stream a :=
  fun (a : Type) {Inh_a : SAWCoreScaffolding.Inhabited a} (n : SAWCoreScaffolding.Nat) (s : Stream (SAWCoreVectorsAsCoqVectors.Vec (SAWCoreScaffolding.Succ n) a)) => MkStream a (fun (i : SAWCoreScaffolding.Nat) => SAWCorePrelude.sawAt (SAWCoreScaffolding.Succ n) a (streamGet (SAWCoreVectorsAsCoqVectors.Vec (SAWCoreScaffolding.Succ n) a) s (divNat i (SAWCoreScaffolding.Succ n))) (modNat i (SAWCoreScaffolding.Succ n))).
