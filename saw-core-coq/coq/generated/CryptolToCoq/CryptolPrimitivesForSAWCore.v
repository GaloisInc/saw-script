...
Definition bvExp : forall (n : @SAWCoreScaffolding.Nat), @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool :=
  fun (n : @SAWCoreScaffolding.Nat) (x : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (y : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) => @SAWVectorsAsCoqVectors.foldr @SAWCoreScaffolding.Bool (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) n (fun (b : @SAWCoreScaffolding.Bool) (a : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) => if b then @SAWVectorsAsCoqVectors.bvMul n x (@SAWVectorsAsCoqVectors.bvMul n a a) else @SAWVectorsAsCoqVectors.bvMul n a a) (@SAWVectorsAsCoqVectors.bvNat n 1) (@SAWCorePrelude.reverse n @SAWCoreScaffolding.Bool y).
...
Definition seq : @Num -> Type -> Type :=
  fun (num : @Num) (a : Type) => CryptolPrimitivesForSAWCore.Num_rect (fun (num1 : @Num) => Type) (fun (n : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n a) (@SAWCorePrelude.Stream a) num.

Definition seq_TCNum : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @SAWCoreScaffolding.Eq Type (@seq (@TCNum n) a) (@SAWVectorsAsCoqVectors.Vec n a) :=
  fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCoreScaffolding.Refl Type (@SAWVectorsAsCoqVectors.Vec n a).
...
Definition from : forall (a : Type), forall (b : Type), forall (m : @Num), forall (n : @Num), @seq m a -> (a -> @seq n b) -> @seq (@tcMul m n) (prod a b) :=
  fun (a : Type) (b : Type) (m : @Num) (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (m1 : @Num) => @seq m a -> (a -> @seq n b) -> @seq (@tcMul m n) (prod a b)) (fun (m1 : @SAWCoreScaffolding.Nat) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWVectorsAsCoqVectors.Vec m a -> (a -> @seq n b) -> @seq (@tcMul (@TCNum m) n) (prod a b)) (fun (n1 : @SAWCoreScaffolding.Nat) (xs : @SAWVectorsAsCoqVectors.Vec m a) (k : a -> @SAWVectorsAsCoqVectors.Vec n1 b) => @SAWCorePrelude.join m n (prod a b) (@SAWCorePrelude.map a (@SAWVectorsAsCoqVectors.Vec n (prod a b)) (fun (x : a) => @SAWCorePrelude.map b (prod a b) (fun (y : b) => pair x y) n (k x)) m xs)) (@SAWCorePrelude.natCase (fun (m' : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec m' a -> (a -> @SAWCorePrelude.Stream b) -> @seq (@SAWCorePrelude.if0Nat @Num m' (@TCNum 0) @TCInf) (prod a b)) (fun (xs : @SAWVectorsAsCoqVectors.Vec 0 a) (k : a -> @SAWCorePrelude.Stream b) => @SAWVectorsAsCoqVectors.EmptyVec (prod a b)) (fun (m' : @SAWCoreScaffolding.Nat) (xs : @SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ m') a) (k : a -> @SAWCorePrelude.Stream b) => (fun (x : a) => @SAWCorePrelude.streamMap b (prod a b) (fun (y : b) => pair x y) (k x)) (@SAWCorePrelude.sawAt (@SAWCoreScaffolding.Succ m') a xs 0)) m) n) (CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWCorePrelude.Stream a -> (a -> @seq n b) -> @seq (@tcMul @TCInf n) (prod a b)) (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.natCase (fun (n' : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.Stream a -> (a -> @SAWVectorsAsCoqVectors.Vec n' b) -> @seq (@SAWCorePrelude.if0Nat @Num n' (@TCNum 0) @TCInf) (prod a b)) (fun (xs : @SAWCorePrelude.Stream a) (k : a -> @SAWVectorsAsCoqVectors.Vec 0 b) => @SAWVectorsAsCoqVectors.EmptyVec (prod a b)) (fun (n' : @SAWCoreScaffolding.Nat) (xs : @SAWCorePrelude.Stream a) (k : a -> @SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ n') b) => @SAWCorePrelude.streamJoin (prod a b) n' (@SAWCorePrelude.streamMap a (@SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ n') (prod a b)) (fun (x : a) => @SAWCorePrelude.map b (prod a b) (fun (y : b) => pair x y) (@SAWCoreScaffolding.Succ n') (k x)) xs)) n) (fun (xs : @SAWCorePrelude.Stream a) (k : a -> @SAWCorePrelude.Stream b) => (fun (x : a) => @SAWCorePrelude.streamMap b (prod a b) (fun (y : b) => pair x y) (k x)) (@SAWCorePrelude.streamGet a xs 0)) n) m.

Definition mlet : forall (a : Type), forall (b : Type), forall (n : @Num), a -> (a -> @seq n b) -> @seq n (prod a b) :=
  fun (a : Type) (b : Type) (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => a -> (a -> @seq n b) -> @seq n (prod a b)) (fun (n1 : @SAWCoreScaffolding.Nat) (x : a) (f : a -> @SAWVectorsAsCoqVectors.Vec n1 b) => @SAWCorePrelude.map b (prod a b) (fun (y : b) => pair x y) n (f x)) (fun (x : a) (f : a -> @SAWCorePrelude.Stream b) => @SAWCorePrelude.streamMap b (prod a b) (fun (y : b) => pair x y) (f x)) n.

Definition seqZip : forall (a : Type), forall (b : Type), forall (m : @Num), forall (n : @Num), @seq m a -> @seq n b -> @seq (@tcMin m n) (prod a b) :=
  fun (a : Type) (b : Type) (m : @Num) (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (m1 : @Num) => @seq m a -> @seq n b -> @seq (@tcMin m n) (prod a b)) (fun (m1 : @SAWCoreScaffolding.Nat) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWVectorsAsCoqVectors.Vec m a -> @seq n b -> @seq (@tcMin (@TCNum m) n) (prod a b)) (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.zip a b m n) (fun (xs : @SAWVectorsAsCoqVectors.Vec m a) (ys : @SAWCorePrelude.Stream b) => @SAWVectorsAsCoqVectors.gen m (prod a b) (fun (i : @SAWCoreScaffolding.Nat) => pair (@SAWCorePrelude.sawAt m a xs i) (@SAWCorePrelude.streamGet b ys i))) n) (CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWCorePrelude.Stream a -> @seq n b -> @seq (@tcMin @TCInf n) (prod a b)) (fun (n1 : @SAWCoreScaffolding.Nat) (xs : @SAWCorePrelude.Stream a) (ys : @SAWVectorsAsCoqVectors.Vec n1 b) => @SAWVectorsAsCoqVectors.gen n (prod a b) (fun (i : @SAWCoreScaffolding.Nat) => pair (@SAWCorePrelude.streamGet a xs i) (@SAWCorePrelude.sawAt n b ys i))) (@SAWCorePrelude.streamMap2 a b (prod a b) (fun (x : a) (y : b) => pair x y)) n) m.
...
Definition bvCmp : forall (n : @SAWCoreScaffolding.Nat), @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  fun (n : @SAWCoreScaffolding.Nat) (x : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (y : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (k : @SAWCoreScaffolding.Bool) => @SAWCoreScaffolding.or (@SAWVectorsAsCoqVectors.bvult n x y) (@SAWCoreScaffolding.and (@SAWCorePrelude.bvEq n x y) k).

Definition bvSCmp : forall (n : @SAWCoreScaffolding.Nat), @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  fun (n : @SAWCoreScaffolding.Nat) (x : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (y : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (k : @SAWCoreScaffolding.Bool) => @SAWCoreScaffolding.or (@SAWVectorsAsCoqVectors.bvslt n x y) (@SAWCoreScaffolding.and (@SAWCorePrelude.bvEq n x y) k).

Definition vecCmp : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), (a -> a -> @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) -> @SAWVectorsAsCoqVectors.Vec n a -> @SAWVectorsAsCoqVectors.Vec n a -> @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  fun (n : @SAWCoreScaffolding.Nat) (a : Type) (f : a -> a -> @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) (xs : @SAWVectorsAsCoqVectors.Vec n a) (ys : @SAWVectorsAsCoqVectors.Vec n a) (k : @SAWCoreScaffolding.Bool) => @SAWVectorsAsCoqVectors.foldr (@SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) @SAWCoreScaffolding.Bool n (fun (f1 : @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) => f) k (@SAWCorePrelude.zipWith a a (@SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) f n xs ys).
...
Definition PEqVec : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @PEq a -> @PEq (@SAWVectorsAsCoqVectors.Vec n a) :=
...
Definition PEqWord : forall (n : @SAWCoreScaffolding.Nat), @PEq (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
...
Definition PCmpVec : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @PCmp a -> @PCmp (@SAWVectorsAsCoqVectors.Vec n a) :=
...
Definition PCmpWord : forall (n : @SAWCoreScaffolding.Nat), @PCmp (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
...
Definition PSignedCmpVec : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @PSignedCmp a -> @PSignedCmp (@SAWVectorsAsCoqVectors.Vec n a) :=
...
Definition PSignedCmpWord : forall (n : @SAWCoreScaffolding.Nat), @PSignedCmp (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
...
Definition PZeroSeqBool : forall (n : @Num), @PZero (@seq n @SAWCoreScaffolding.Bool) :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @PZero (@seq n @SAWCoreScaffolding.Bool)) (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.bvNat n 0) (@SAWCorePrelude.streamConst @SAWCoreScaffolding.Bool @SAWCoreScaffolding.false) n.
...
Definition PLogicVec : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @PLogic a -> @PLogic (@SAWVectorsAsCoqVectors.Vec n a) :=
...
Definition PLogicWord : forall (n : @SAWCoreScaffolding.Nat), @PLogic (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
  fun (n : @SAWCoreScaffolding.Nat) => RecordCons "and" (@SAWCorePrelude.bvAnd n) (RecordCons "logicZero" (@SAWVectorsAsCoqVectors.bvNat n 0) (RecordCons "not" (@SAWCorePrelude.bvNot n) (RecordCons "or" (@SAWCorePrelude.bvOr n) (RecordCons "xor" (@SAWCorePrelude.bvXor n) RecordNil)))).
...
Definition PRingVec : forall (n : @SAWCoreScaffolding.Nat), forall (a : Type), @PRing a -> @PRing (@SAWVectorsAsCoqVectors.Vec n a) :=
...
Definition PRingWord : forall (n : @SAWCoreScaffolding.Nat), @PRing (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
  fun (n : @SAWCoreScaffolding.Nat) => RecordCons "add" (@SAWVectorsAsCoqVectors.bvAdd n) (RecordCons "int" (@SAWCorePrelude.intToBv n) (RecordCons "mul" (@SAWVectorsAsCoqVectors.bvMul n) (RecordCons "neg" (@SAWVectorsAsCoqVectors.bvNeg n) (RecordCons "ringZero" (@SAWVectorsAsCoqVectors.bvNat n 0) (RecordCons "sub" (@SAWVectorsAsCoqVectors.bvSub n) RecordNil))))).
...
Definition PIntegralWord : forall (n : @SAWCoreScaffolding.Nat), @PIntegral (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) :=
  fun (n : @SAWCoreScaffolding.Nat) => RecordCons "div" (@SAWVectorsAsCoqVectors.bvUDiv n) (RecordCons "integralRing" (@PRingWord n) (RecordCons "mod" (@SAWVectorsAsCoqVectors.bvURem n) (RecordCons "posNegCases" (fun (r : Type) (pos : @SAWCoreScaffolding.Nat -> r) (neg : @SAWCoreScaffolding.Nat -> r) (i : @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) => pos (@SAWVectorsAsCoqVectors.bvToNat n i)) (RecordCons "toInt" (@SAWCorePrelude.bvToInt n) RecordNil)))).
...
Definition PLiteralSeqBool : forall (n : @Num), @PLiteral (@seq n @SAWCoreScaffolding.Bool) :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @PLiteral (@seq n @SAWCoreScaffolding.Bool)) @SAWVectorsAsCoqVectors.bvNat (@SAWCoreScaffolding.error (@PLiteral (@SAWCorePrelude.Stream @SAWCoreScaffolding.Bool)) "PLiteralSeqBool: no instance for streams"%string) n.
...
Definition ecLg2 : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool) @SAWVectorsAsCoqVectors.bvLg2 (@SAWCoreScaffolding.error (@SAWCorePrelude.Stream @SAWCoreScaffolding.Bool -> @SAWCorePrelude.Stream @SAWCoreScaffolding.Bool) "ecLg2: expected finite word"%string) n.

Definition ecSDiv : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool) (@SAWCorePrelude.Nat__rec (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (@SAWCoreScaffolding.error (@SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool) "ecSDiv: illegal 0-width word"%string) (fun (n' : @SAWCoreScaffolding.Nat) (_1 : @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool) => @SAWVectorsAsCoqVectors.bvSDiv n')) (@SAWCoreScaffolding.error (@SAWCorePrelude.Stream @SAWCoreScaffolding.Bool -> @SAWCorePrelude.Stream @SAWCoreScaffolding.Bool -> @SAWCorePrelude.Stream @SAWCoreScaffolding.Bool) "ecSDiv: expected finite word"%string) n.

Definition ecSMod : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool) (@SAWCorePrelude.Nat__rec (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (@SAWCoreScaffolding.error (@SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool) "ecSMod: illegal 0-width word"%string) (fun (n' : @SAWCoreScaffolding.Nat) (_1 : @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool) => @SAWVectorsAsCoqVectors.bvSRem n')) (@SAWCoreScaffolding.error (@SAWCorePrelude.Stream @SAWCoreScaffolding.Bool -> @SAWCorePrelude.Stream @SAWCoreScaffolding.Bool -> @SAWCorePrelude.Stream @SAWCoreScaffolding.Bool) "ecSMod: expected finite word"%string) n.
...
Definition ecSShiftR : forall (n : @Num), forall (ix : Type), @PIntegral ix -> @seq n @SAWCoreScaffolding.Bool -> ix -> @seq n @SAWCoreScaffolding.Bool :=
  @finNumRec (fun (n : @Num) => forall (ix : Type), @PIntegral ix -> @seq n @SAWCoreScaffolding.Bool -> ix -> @seq n @SAWCoreScaffolding.Bool) (fun (n : @SAWCoreScaffolding.Nat) (ix : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) => @SAWCorePrelude.natCase (fun (w : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec w @SAWCoreScaffolding.Bool -> ix -> @SAWVectorsAsCoqVectors.Vec w @SAWCoreScaffolding.Bool) (fun (xs : @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool) (_1 : ix) => xs) (fun (w : @SAWCoreScaffolding.Nat) (xs : @SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ w) @SAWCoreScaffolding.Bool) => RecordProj pix "posNegCases" (@SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ w) @SAWCoreScaffolding.Bool) (@SAWVectorsAsCoqVectors.bvSShr w xs) (@SAWVectorsAsCoqVectors.bvShl (@SAWCoreScaffolding.Succ w) xs)) n).

Definition ecRotL : forall (m : @Num), forall (ix : Type), forall (a : Type), @PIntegral ix -> @seq m a -> ix -> @seq m a :=
  @finNumRec (fun (m : @Num) => forall (ix : Type), forall (a : Type), @PIntegral ix -> @seq m a -> ix -> @seq m a) (fun (m : @SAWCoreScaffolding.Nat) (ix : Type) (a : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) (xs : @SAWVectorsAsCoqVectors.Vec m a) => RecordProj pix "posNegCases" (@SAWVectorsAsCoqVectors.Vec m a) (@SAWVectorsAsCoqVectors.rotateL m a xs) (@SAWVectorsAsCoqVectors.rotateR m a xs)).

Definition ecRotR : forall (m : @Num), forall (ix : Type), forall (a : Type), @PIntegral ix -> @seq m a -> ix -> @seq m a :=
  @finNumRec (fun (m : @Num) => forall (ix : Type), forall (a : Type), @PIntegral ix -> @seq m a -> ix -> @seq m a) (fun (m : @SAWCoreScaffolding.Nat) (ix : Type) (a : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) (xs : @SAWVectorsAsCoqVectors.Vec m a) => RecordProj pix "posNegCases" (@SAWVectorsAsCoqVectors.Vec m a) (@SAWVectorsAsCoqVectors.rotateR m a xs) (@SAWVectorsAsCoqVectors.rotateL m a xs)).

Definition ecCat : forall (m : @Num), forall (n : @Num), forall (a : Type), @seq m a -> @seq n a -> @seq (@tcAdd m n) a :=
  @finNumRec (fun (m : @Num) => forall (n : @Num), forall (a : Type), @seq m a -> @seq n a -> @seq (@tcAdd m n) a) (fun (m : @SAWCoreScaffolding.Nat) => @CryptolPrimitivesForSAWCORE.Num_rect (fun (n : @Num) => forall (a : Type), @SAWVectorsAsCoqVectors.Vec m a -> @seq n a -> @seq (@tcAdd (@TCNum m) n) a) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCorePrelude.append m n a) (fun (a : Type) => @SAWCorePrelude.streamAppend a m)).

Definition ecSplitAt : forall (m : @Num), forall (n : @Num), forall (a : Type), @seq (@tcAdd m n) a -> prod (@seq m a) (@seq n a) :=
  @finNumRec (fun (m : @Num) => forall (n : @Num), forall (a : Type), @seq (@tcAdd m n) a -> prod (@seq m a) (@seq n a)) (fun (m : @SAWCoreScaffolding.Nat) => @CryptolPrimitivesForSAWCORE.Num_rect (fun (n : @Num) => forall (a : Type), @seq (@tcAdd (@TCNum m) n) a -> prod (@SAWVectorsAsCoqVectors.Vec m a) (@seq n a)) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) (xs : @SAWVectorsAsCoqVectors.Vec (@SAWCorePrelude.addNat m n) a) => pair (@SAWCorePrelude.take a m n xs) (@SAWCorePrelude.drop a m n xs)) (fun (a : Type) (xs : @SAWCorePrelude.Stream a) => pair (@SAWCorePrelude.streamTake a m xs) (@SAWCorePrelude.streamDrop a m xs))).

Definition ecJoin : forall (m : @Num), forall (n : @Num), forall (a : Type), @seq m (@seq n a) -> @seq (@tcMul m n) a :=
  fun (m : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (m1 : @Num) => forall (n : @Num), forall (a : Type), @seq m (@seq n a) -> @seq (@tcMul m n) a) (fun (m1 : @SAWCoreScaffolding.Nat) => @finNumRec (fun (n : @Num) => forall (a : Type), @SAWVectorsAsCoqVectors.Vec m (@seq n a) -> @seq (@tcMul (@TCNum m) n) a) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCorePrelude.join m n a)) (@finNumRec (fun (n : @Num) => forall (a : Type), @SAWCorePrelude.Stream (@seq n a) -> @seq (@tcMul @TCInf n) a) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCorePrelude.natCase (fun (n' : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec n' a) -> @seq (@SAWCorePrelude.if0Nat @Num n' (@TCNum 0) @TCInf) a) (fun (s : @SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec 0 a)) => @SAWVectorsAsCoqVectors.EmptyVec a) (fun (n' : @SAWCoreScaffolding.Nat) (s : @SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec (@SAWCoreScaffolding.Succ n') a)) => @SAWCorePrelude.streamJoin a n' s) n)) m.

Definition ecSplit : forall (m : @Num), forall (n : @Num), forall (a : Type), @seq (@tcMul m n) a -> @seq m (@seq n a) :=
  fun (m : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (m1 : @Num) => forall (n : @Num), forall (a : Type), @seq (@tcMul m n) a -> @seq m (@seq n a)) (fun (m1 : @SAWCoreScaffolding.Nat) => @finNumRec (fun (n : @Num) => forall (a : Type), @seq (@tcMul (@TCNum m) n) a -> @SAWVectorsAsCoqVectors.Vec m (@seq n a)) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCorePrelude.split m n a)) (@finNumRec (fun (n : @Num) => forall (a : Type), @seq (@tcMul @TCInf n) a -> @SAWCorePrelude.Stream (@seq n a)) (fun (n : @SAWCoreScaffolding.Nat) (a : Type) => @SAWCorePrelude.natCase (fun (n' : @SAWCoreScaffolding.Nat) => @seq (@SAWCorePrelude.if0Nat @Num n' (@TCNum 0) @TCInf) a -> @SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec n' a)) (@SAWCorePrelude.streamConst (@SAWVectorsAsCoqVectors.Vec 0 a)) (fun (n' : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.streamSplit a (@SAWCoreScaffolding.Succ n')) n)) m.
...
Definition ecTranspose : forall (m : @Num), forall (n : @Num), forall (a : Type), @seq m (@seq n a) -> @seq n (@seq m a) :=
  fun (m : @Num) (n : @Num) (a : Type) => CryptolPrimitivesForSAWCore.Num_rect (fun (m1 : @Num) => @seq m (@seq n a) -> @seq n (@seq m a)) (fun (m1 : @SAWCoreScaffolding.Nat) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWVectorsAsCoqVectors.Vec m (@seq n a) -> @seq n (@SAWVectorsAsCoqVectors.Vec m a)) (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.transpose m n a) (fun (xss : @SAWVectorsAsCoqVectors.Vec m (@SAWCorePrelude.Stream a)) => @SAWCorePrelude.MkStream (@SAWVectorsAsCoqVectors.Vec m a) (fun (i : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.gen m a (fun (j : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.streamGet a (@SAWCorePrelude.sawAt m (@SAWCorePrelude.Stream a) xss j) i))) n) (CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @SAWCorePrelude.Stream (@seq n a) -> @seq n (@SAWCorePrelude.Stream a)) (fun (n1 : @SAWCoreScaffolding.Nat) (xss : @SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec n1 a)) => @SAWVectorsAsCoqVectors.gen n (@SAWCorePrelude.Stream a) (fun (i : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.MkStream a (fun (j : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.sawAt n a (@SAWCorePrelude.streamGet (@SAWVectorsAsCoqVectors.Vec n a) xss j) i))) (fun (xss : @SAWCorePrelude.Stream (@SAWCorePrelude.Stream a)) => @SAWCorePrelude.MkStream (@SAWCorePrelude.Stream a) (fun (i : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.MkStream a (fun (j : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.streamGet a (@SAWCorePrelude.streamGet (@SAWCorePrelude.Stream a) xss j) i))) n) m.

Definition ecAt : forall (n : @Num), forall (a : Type), forall (ix : Type), @PIntegral ix -> @seq n a -> ix -> a :=
  fun (n : @Num) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => forall (a : Type), forall (ix : Type), @PIntegral ix -> @seq n a -> ix -> a) (fun (n1 : @SAWCoreScaffolding.Nat) (a : Type) (ix : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) (xs : @SAWVectorsAsCoqVectors.Vec n1 a) => RecordProj pix "posNegCases" a (@SAWCorePrelude.sawAt n a xs) (fun (_1 : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.sawAt n a xs 0)) (fun (a : Type) (ix : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) (xs : @SAWCorePrelude.Stream a) => RecordProj pix "posNegCases" a (@SAWCorePrelude.streamGet a xs) (fun (_1 : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.streamGet a xs 0)) n.

Definition ecAtBack : forall (n : @Num), forall (a : Type), forall (ix : Type), @PIntegral ix -> @seq n a -> ix -> a :=
  fun (n : @Num) (a : Type) (ix : Type) (pix : RecordTypeCons "div" (ix -> ix -> ix) (RecordTypeCons "integralRing" (RecordTypeCons "add" (ix -> ix -> ix) (RecordTypeCons "int" (@SAWCoreScaffolding.Integer -> ix) (RecordTypeCons "mul" (ix -> ix -> ix) (RecordTypeCons "neg" (ix -> ix) (RecordTypeCons "ringZero" ix (RecordTypeCons "sub" (ix -> ix -> ix) RecordTypeNil)))))) (RecordTypeCons "mod" (ix -> ix -> ix) (RecordTypeCons "posNegCases" (forall (r : Type), (@SAWCoreScaffolding.Nat -> r) -> (@SAWCoreScaffolding.Nat -> r) -> ix -> r) (RecordTypeCons "toInt" (ix -> @SAWCoreScaffolding.Integer) RecordTypeNil))))) (xs : CryptolPrimitivesForSAWCore.Num_rect (fun (num : @Num) => Type) (fun (n1 : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n a) (@SAWCorePrelude.Stream a) n) => @ecAt n a ix pix (@ecReverse n a xs).
...
Definition ecError : forall (a : Type), forall (len : @Num), @seq len (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool) -> a :=
  fun (a : Type) (len : @Num) (msg : CryptolPrimitivesForSAWCore.Num_rect (fun (num : @Num) => Type) (fun (n : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool)) (@SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool)) len) => @SAWCoreScaffolding.error a "encountered call to the Cryptol 'error' function"%string.

Definition ecRandom : forall (a : Type), @SAWVectorsAsCoqVectors.Vec 32 @SAWCoreScaffolding.Bool -> a :=
  fun (a : Type) (_1 : @SAWVectorsAsCoqVectors.Vec 32 @SAWCoreScaffolding.Bool) => @SAWCoreScaffolding.error a "Cryptol.random"%string.

Definition ecTrace : forall (n : @Num), forall (a : Type), forall (b : Type), @seq n (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool) -> a -> b -> b :=
  fun (_1 : @Num) (_2 : Type) (_3 : Type) (_4 : CryptolPrimitivesForSAWCore.Num_rect (fun (num : @Num) => Type) (fun (n : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool)) (@SAWCorePrelude.Stream (@SAWVectorsAsCoqVectors.Vec 8 @SAWCoreScaffolding.Bool)) _1) (_5 : _2) (x : _3) => x.
...
Definition ecParmap : forall (a : Type), forall (b : Type), forall (n : @Num), @PEq b -> (a -> b) -> @seq n a -> @seq n b :=
  fun (a : Type) (b : Type) (n : @Num) (pb : RecordTypeCons "eq" (b -> b -> @SAWCoreScaffolding.Bool) RecordTypeNil) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => (a -> b) -> @seq n a -> @seq n b) (fun (n1 : @SAWCoreScaffolding.Nat) (f : a -> b) (xs : @SAWVectorsAsCoqVectors.Vec n1 a) => @SAWCorePrelude.map a b f n xs) (fun (f : a -> b) (xs : @SAWCorePrelude.Stream a) => @SAWCoreScaffolding.error (@SAWCorePrelude.Stream b) "Unexpected infinite stream in parmap"%string) n.

Definition ecFoldl : forall (n : @Num), forall (a : Type), forall (b : Type), (a -> b -> a) -> a -> @seq n b -> a :=
  fun (n : @Num) (a : Type) (b : Type) (f : a -> b -> a) (z : a) => CryptolPrimitivesForSAWCore.Num_rect (fun (n1 : @Num) => @seq n b -> a) (fun (n1 : @SAWCoreScaffolding.Nat) (xs : @SAWVectorsAsCoqVectors.Vec n1 b) => @SAWVectorsAsCoqVectors.foldr b a n (fun (y : b) (x : a) => f x y) z (@SAWCorePrelude.reverse n b xs)) (fun (xs : @SAWCorePrelude.Stream b) => @SAWCoreScaffolding.error a "Unexpected infinite stream in foldl"%string) n.
...
Definition ecFpAdd : forall (e : @Num), forall (p : @Num), @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool -> @TCFloat e p -> @TCFloat e p -> @TCFloat e p :=
  fun (e : @Num) (p : @Num) (_1 : @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool) (_2 : unit) (_3 : unit) => @SAWCoreScaffolding.error (@TCFloat e p) "Unimplemented: fpAdd"%string.

Definition ecFpSub : forall (e : @Num), forall (p : @Num), @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool -> @TCFloat e p -> @TCFloat e p -> @TCFloat e p :=
  fun (e : @Num) (p : @Num) (_1 : @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool) (_2 : unit) (_3 : unit) => @SAWCoreScaffolding.error (@TCFloat e p) "Unimplemented: fpSub"%string.

Definition ecFpMul : forall (e : @Num), forall (p : @Num), @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool -> @TCFloat e p -> @TCFloat e p -> @TCFloat e p :=
  fun (e : @Num) (p : @Num) (_1 : @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool) (_2 : unit) (_3 : unit) => @SAWCoreScaffolding.error (@TCFloat e p) "Unimplemented: fpMul"%string.

Definition ecFpDiv : forall (e : @Num), forall (p : @Num), @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool -> @TCFloat e p -> @TCFloat e p -> @TCFloat e p :=
  fun (e : @Num) (p : @Num) (_1 : @SAWVectorsAsCoqVectors.Vec 3 @SAWCoreScaffolding.Bool) (_2 : unit) (_3 : unit) => @SAWCoreScaffolding.error (@TCFloat e p) "Unimplemented: fpDiv"%string.
...
Definition ecSExt : forall (m : @Num), forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq (@tcAdd m n) @SAWCoreScaffolding.Bool :=
  @finNumRec2 (fun (m : @Num) (n : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq (@tcAdd m n) @SAWCoreScaffolding.Bool) (fun (m : @SAWCoreScaffolding.Nat) (n : @SAWCoreScaffolding.Nat) => @SAWCorePrelude.natCase (fun (n' : @SAWCoreScaffolding.Nat) => @SAWVectorsAsCoqVectors.Vec n' @SAWCoreScaffolding.Bool -> @SAWVectorsAsCoqVectors.Vec (@SAWCorePrelude.addNat m n') @SAWCoreScaffolding.Bool) (fun (_1 : @SAWVectorsAsCoqVectors.Vec 0 @SAWCoreScaffolding.Bool) => @SAWVectorsAsCoqVectors.bvNat (@SAWCorePrelude.addNat m 0) 0) (@SAWCorePrelude.bvSExt m) n).

Definition ecSgt : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  @finNumRec (fun (n : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) @SAWVectorsAsCoqVectors.bvsgt.

Definition ecSge : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  @finNumRec (fun (n : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) @SAWVectorsAsCoqVectors.bvsge.

Definition ecSlt : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  @finNumRec (fun (n : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) @SAWVectorsAsCoqVectors.bvslt.

Definition ecSle : forall (n : @Num), @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool :=
  @finNumRec (fun (n : @Num) => @seq n @SAWCoreScaffolding.Bool -> @seq n @SAWCoreScaffolding.Bool -> @SAWCoreScaffolding.Bool) @SAWVectorsAsCoqVectors.bvsle.
...
Axiom replicate_False : forall (n : @SAWCoreScaffolding.Nat), @SAWCoreScaffolding.Eq (@SAWVectorsAsCoqVectors.Vec n @SAWCoreScaffolding.Bool) (@SAWCorePrelude.replicate n @SAWCoreScaffolding.Bool @SAWCoreScaffolding.false) (@SAWVectorsAsCoqVectors.bvNat n 0) .
