...
Definition finNumRec2 : forall (p : @Num -> @Num -> Type), (forall (m : @SAWCoreScaffolding.Nat), forall (n : @SAWCoreScaffolding.Nat), let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  p (@TCNum m) (@TCNum n)) -> forall (m : @Num), forall (n : @Num), p m n :=
  fun (p : @Num -> @Num -> Type) (f : forall (m : @SAWCoreScaffolding.Nat), forall (n : @SAWCoreScaffolding.Nat), let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  p (@TCNum m) (@TCNum n)) => @finNumRec (fun (m : @Num) => forall (n : @Num), p m n) (fun (m : @SAWCoreScaffolding.Nat) => @finNumRec (p (@TCNum m)) (f m)).
...
Definition ecFromTo : forall (first : @Num), forall (last : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcSub last first)) a :=
  @finNumRec (fun (first : @Num) => forall (last : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcSub last first)) a) (fun (first : @SAWCoreScaffolding.Nat) => @finNumRec (fun (last : @Num) => forall (a : Type), @PLiteral a -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  @seq (@tcAdd (@TCNum 1) (@tcSub last (@TCNum first))) a) (fun (last : @SAWCoreScaffolding.Nat) (a : Type) (pa : @SAWCoreScaffolding.Nat -> a) => @SAWCoreVectorsAsCoqVectors.gen (@SAWCorePrelude.addNat 1 (@SAWCorePrelude.subNat last first)) a (fun (i : @SAWCoreScaffolding.Nat) => pa (@SAWCorePrelude.addNat i first)))).
...
Definition ecFromToBy : forall (first : @Num), forall (last : @Num), forall (stride : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub last first) stride)) a :=
  @finNumRec (fun (first : @Num) => forall (last : @Num), forall (stride : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub last first) stride)) a) (fun (first : @SAWCoreScaffolding.Nat) => @finNumRec (fun (last : @Num) => forall (stride : @Num), forall (a : Type), @PLiteral a -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub last (@TCNum first)) stride)) a) (fun (last : @SAWCoreScaffolding.Nat) => @finNumRec (fun (stride : @Num) => forall (a : Type), @PLiteral a -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  @seq (@tcAdd (@TCNum 1) (@tcDiv (@TCNum (@SAWCorePrelude.subNat last first)) stride)) a) (fun (stride : @SAWCoreScaffolding.Nat) (a : Type) (pa : @SAWCoreScaffolding.Nat -> a) => @SAWCoreVectorsAsCoqVectors.gen (@SAWCorePrelude.addNat 1 (@SAWCorePrelude.divNat (@SAWCorePrelude.subNat last first) stride)) a (fun (i : @SAWCoreScaffolding.Nat) => pa (@SAWCorePrelude.addNat first (@SAWCorePrelude.mulNat i stride)))))).

Definition ecFromToByLessThan : forall (first : @Num), forall (bound : @Num), forall (stride : @Num), forall (a : Type), @PLiteralLessThan a -> @seq (@tcCeilDiv (@tcSub bound first) stride) a :=
  @finNumRec (fun (first : @Num) => forall (bound : @Num), forall (stride : @Num), forall (a : Type), @PLiteralLessThan a -> @seq (@tcCeilDiv (@tcSub bound first) stride) a) (fun (first : @SAWCoreScaffolding.Nat) => @CryptolPrimitivesForSAWCore.Num_rect (fun (bound : @Num) => forall (stride : @Num), forall (a : Type), @PLiteralLessThan a -> @seq (@tcCeilDiv (@tcSub bound (@TCNum first)) stride) a) (fun (bound : @SAWCoreScaffolding.Nat) => @finNumRec (fun (stride : @Num) => forall (a : Type), @PLiteralLessThan a -> @seq (@tcCeilDiv (@TCNum (@SAWCorePrelude.subNat bound first)) stride) a) (fun (stride : @SAWCoreScaffolding.Nat) (a : Type) (pa : @SAWCoreScaffolding.Nat -> a) => @SAWCoreVectorsAsCoqVectors.gen (@ceilDivNat (@SAWCorePrelude.subNat bound first) stride) a (fun (i : @SAWCoreScaffolding.Nat) => pa (@SAWCorePrelude.addNat first (@SAWCorePrelude.mulNat i stride))))) (@finNumRec (fun (stride : @Num) => forall (a : Type), @PLiteralLessThan a -> @seq (@tcCeilDiv (@TCInf) stride) a) (fun (stride : @SAWCoreScaffolding.Nat) (a : Type) (pa : @SAWCoreScaffolding.Nat -> a) => @SAWCorePrelude.MkStream a (fun (i : @SAWCoreScaffolding.Nat) => pa (@SAWCorePrelude.addNat first (@SAWCorePrelude.mulNat i stride)))))).

Definition ecFromToDownBy : forall (first : @Num), forall (last : @Num), forall (stride : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub first last) stride)) a :=
  @finNumRec (fun (first : @Num) => forall (last : @Num), forall (stride : @Num), forall (a : Type), @PLiteral a -> @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub first last) stride)) a) (fun (first : @SAWCoreScaffolding.Nat) => @finNumRec (fun (last : @Num) => forall (stride : @Num), forall (a : Type), @PLiteral a -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  @seq (@tcAdd (@TCNum 1) (@tcDiv (@tcSub (@TCNum first) last) stride)) a) (fun (last : @SAWCoreScaffolding.Nat) => @finNumRec (fun (stride : @Num) => forall (a : Type), @PLiteral a -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
...
Definition ecFromToDownByGreaterThan : forall (first : @Num), forall (bound : @Num), forall (stride : @Num), forall (a : Type), @PLiteral a -> @seq (@tcCeilDiv (@tcSub first bound) stride) a :=
...
Definition AESKeyExpand : forall (k : @Num), @seq k (@SAWCoreVectorsAsCoqVectors.Vec 32 (@SAWCoreScaffolding.Bool)) -> let var__0   := @SAWCoreScaffolding.Nat -> @Num in
  @seq (@tcMul (@TCNum 4) (@tcAdd (@TCNum 7) k)) (@SAWCoreVectorsAsCoqVectors.Vec 32 (@SAWCoreScaffolding.Bool)) :=
