...
We currently have a circular dependency in the submodules so `git
submodule --init --recursive` doesn't terminate; see
[macaw #283](https://github.com/GaloisInc/macaw/issues/283).
