...
SAW has experimental support for analysis of hardware descriptions written in Verilog or VHDL ([via GHDL](https://github.com/ghdl/ghdl-yosys-plugin)) through an intermediate representation produced by [Yosys](https://yosyshq.net/yosys/).
